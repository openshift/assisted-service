...
const (
	...
	// ImageTypeDisconnectedIso captures enum value "disconnected-iso"
	ImageTypeDisconnectedIso ImageType = "disconnected-iso"
)
...
func init() {
	var res []ImageType
	if err := json.Unmarshal([]byte(`["full-iso","minimal-iso","disconnected-iso"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
