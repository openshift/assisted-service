...
type Manifest struct {
	...
	// Describes whether manifest is user-supplied or system-generated.
	// Enum: [user-supplied system-generated]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["user-supplied","system-generated"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// ManifestManifestSourceUserSupplied captures enum value "user-supplied"
	ManifestManifestSourceUserSupplied string = "user-supplied"

	// ManifestManifestSourceSystemGenerated captures enum value "system-generated"
	ManifestManifestSourceSystemGenerated string = "system-generated"
)
