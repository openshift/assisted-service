...
type AgentSpec struct {
	...
	// InstallationDiskByPath defines the installation destination disk using its by-path value.
	// +optional
	InstallationDiskByPath string `json:"installation_disk_by_path,omitempty"`
