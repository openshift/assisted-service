...
func (in *InfraEnvSpec) DeepCopyInto(out *InfraEnvSpec) {
	*out = *in
	...
	if in.NetworkDiscoveryDelaySeconds != nil {
		in, out := &in.NetworkDiscoveryDelaySeconds, &out.NetworkDiscoveryDelaySeconds
		*out = new(int64)
		**out = **in
	}
}
...
func (in *OSImage) DeepCopyInto(out *OSImage) {
	*out = *in
	if in.DefaultOSStream != nil {
		in, out := &in.DefaultOSStream, &out.DefaultOSStream
		*out = new(bool)
		**out = **in
	}
}
