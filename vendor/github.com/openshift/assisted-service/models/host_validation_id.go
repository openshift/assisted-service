...
const (
	...
	// HostValidationIDIscsiHostNetworkInterfaceDoesNotBelongToMachineCidr captures enum value "iscsi-host-network-interface-does-not-belong-to-machine-cidr"
	HostValidationIDIscsiHostNetworkInterfaceDoesNotBelongToMachineCidr HostValidationID = "iscsi-host-network-interface-does-not-belong-to-machine-cidr"
)
