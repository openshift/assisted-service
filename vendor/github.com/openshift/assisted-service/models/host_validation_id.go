...
const (
	...
	// HostValidationIDNoDiskDetected captures enum value "no-disk-detected"
	HostValidationIDNoDiskDetected HostValidationID = "no-disk-detected"
)
