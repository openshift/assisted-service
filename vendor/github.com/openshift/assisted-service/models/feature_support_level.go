...
const (
	...
	// FeatureSupportLevelFeaturesItems0FeatureIDDAY2MASTER captures enum value "DAY2_MASTER"
	FeatureSupportLevelFeaturesItems0FeatureIDDAY2MASTER string = "DAY2_MASTER"
)
