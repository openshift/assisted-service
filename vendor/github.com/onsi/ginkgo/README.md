...
Jump to the [docs](https://onsi.github.io/ginkgo/) | [中文文档](https://ke-chain.github.io/ginkgodoc) to learn more. To start rolling your Ginkgo tests _now_ [keep reading](#set-me-up)!
...
- `ginkgo watch` [watches](https://onsi.github.io/ginkgo/#watching-for-changes) packages _and their dependencies_ for changes, then reruns tests. Run tests immediately as you develop!
