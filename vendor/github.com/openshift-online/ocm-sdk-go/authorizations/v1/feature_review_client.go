...
func (r *FeatureReviewPostRequest) SendContext(ctx context.Context) (result *FeatureReviewPostResponse, err error) {
	...
	err = readFeatureReviewPostResponse(result, response.Body)
	if err != nil {
		return
	}
	return
...
// 'post' method.
func (r *FeatureReviewPostRequest) marshal(writer io.Writer) error {
	stream := helpers.NewStream(writer)
	r.stream(stream)
	return stream.Error
}
func (r *FeatureReviewPostRequest) stream(stream *jsoniter.Stream) {
}
