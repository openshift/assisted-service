...
func readAddonInquiriesListRequest(request *AddonInquiriesListServerRequest, r *http.Request) error {
	var err error
	query := r.URL.Query()
...
func writeAddonInquiriesListResponse(response *AddonInquiriesListServerResponse, w http.ResponseWriter) error {
