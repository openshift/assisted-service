...
func readAvailableRegionsInquirySearchRequest(request *AvailableRegionsInquirySearchServerRequest, r *http.Request) error {
	var err error
	query := r.URL.Query()
...
func writeAvailableRegionsInquirySearchResponse(response *AvailableRegionsInquirySearchServerResponse, w http.ResponseWriter) error {
