...
//
//	mockgen -source=disk_stats_helper.go -package=metrics -destination=mock_disk_stats_helper.go
//
...
func (mr *MockDiskStatsHelperMockRecorder) GetDiskUsage(directory any) *gomock.Call {
