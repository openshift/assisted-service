...
func (m *MetricsManager) MonitoredHostsDurationMs(monitoredHostsMs float64) {
	m.serviceLogicMonitoredHostsDurationMs.WithLabelValues(hosts).Observe(monitoredHostsMs)
}

func (m *MetricsManager) MonitoredClustersDurationMs(monitoredClustersMs float64) {
	m.serviceLogicMonitoredClustersDurationMs.WithLabelValues(clusters).Observe(monitoredClustersMs)
}
