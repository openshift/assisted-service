...
func (mr *MockAPIMockRecorder) BlacklistedClustersCurrent(count any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) InstallerCacheGetReleaseCached(releaseId, cacheHit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) InstallerCacheReleaseEvicted(success any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) MonitoredClustersCycleDurationMs(ctx, duration, fullScan any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAPI) MonitoredClustersDurationMs(ctx context.Context, clusterID strfmt.UUID, duration time.Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "MonitoredClustersDurationMs", ctx, clusterID, duration)
}

// MonitoredClustersDurationMs indicates an expected call of MonitoredClustersDurationMs.
func (mr *MockAPIMockRecorder) MonitoredClustersDurationMs(ctx, clusterID, duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) MonitoredHostsCycleDurationMs(ctx, duration, fullScan any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) MonitoredHostsDurationMs(ctx, hostID, clusterID, duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
