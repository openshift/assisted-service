...
//
//	mockgen -source=uploader.go -package=uploader -destination=mock_uploader.go
//
...
func (mr *MockClientMockRecorder) UploadEvents(ctx, cluster, eventsHandler any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
