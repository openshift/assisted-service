...
//
//	mockgen -source=validator.go -package=connectivity -destination=mock_connectivity_validator.go
//
...
func (mr *MockValidatorMockRecorder) GetHostValidInterfaces(host any) *gomock.Call {
