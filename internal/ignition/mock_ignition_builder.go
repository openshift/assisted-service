...
//
//	mockgen -source=discovery.go -package=ignition -destination=mock_ignition_builder.go
//
...
func (mr *MockIgnitionBuilderMockRecorder) FormatDiscoveryIgnitionFile(ctx, infraEnv, cfg, safeForLogs, authType, overrideDiscoveryISOType any) *gomock.Call {
...
func (mr *MockIgnitionBuilderMockRecorder) FormatSecondDayWorkerIgnitionFile(url, caCert, bearerToken, ignitionEndpointHTTPHeaders, host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
