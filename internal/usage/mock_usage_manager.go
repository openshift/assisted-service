...
//
//	mockgen -source=manager.go -package=usage -destination=mock_usage_manager.go
//
...
func (m *MockAPI) Add(usages FeatureUsage, Name string, data *map[string]any) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Add", usages, Name, data)
}

// Add indicates an expected call of Add.
func (mr *MockAPIMockRecorder) Add(usages, Name, data any) *gomock.Call {
...
func (mr *MockAPIMockRecorder) Remove(usages, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) Save(db, clusterId, usages any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
