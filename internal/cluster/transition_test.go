	...
	tests := []struct {
		...
		},
		{
			...
			validationsChecker: makeJsonChecker(map[validationID]validationCheckResult{
				...
				IsPullSecretSet:                     {status: ValidationSuccess, messagePattern: "The pull secret is set"},
				SufficientMastersCount:              {status: ValidationSuccess, messagePattern: "The cluster has a sufficient number of master candidates."},
				IsOcsRequirementsSatisfied:          {status: ValidationFailure, messagePattern: "Total disks on the cluster must be a multiple of 3 of size >= 5 GB"},
			}),
			errorExpected: false,
		},
		{
		...
		},
		{
			...
			validationsChecker: makeJsonChecker(map[validationID]validationCheckResult{
				...
				IsPullSecretSet:                     {status: ValidationSuccess, messagePattern: "The pull secret is set"},
				SufficientMastersCount:              {status: ValidationSuccess, messagePattern: "The cluster has a sufficient number of master candidates."},
				IsOcsRequirementsSatisfied:          {status: ValidationFailure, messagePattern: "Insufficient Resources to deploy OCS in Compact Mode. A minimum of 81 RAM GB, excluding disk RAM resources is required."},
			}),
			errorExpected: false,
		},
		{
			...
			validationsChecker: makeJsonChecker(map[validationID]validationCheckResult{
				...
				IsPullSecretSet:                     {status: ValidationSuccess, messagePattern: "The pull secret is set"},
				SufficientMastersCount:              {status: ValidationSuccess, messagePattern: "The cluster has a sufficient number of master candidates."},
				IsOcsRequirementsSatisfied:          {status: ValidationFailure, messagePattern: "Insufficient Resources to deploy OCS in Compact Mode. A minimum of 3 Disks of minimum 5GB is required.3 Hosts with disks, is required."},
			}),
			errorExpected: false,
		},
		{
		...
		},
		{
			...
			validationsChecker: makeJsonChecker(map[validationID]validationCheckResult{
				...
				IsPullSecretSet:                     {status: ValidationSuccess, messagePattern: "The pull secret is set"},
				SufficientMastersCount:              {status: ValidationSuccess, messagePattern: "The cluster has a sufficient number of master candidates."},
				IsOcsRequirementsSatisfied:          {status: ValidationFailure, messagePattern: "Insufficient Resources to deploy OCS in Minimal Deployment Mode. A minimum of 51 RAM GB, excluding disk RAM resources is required."},
			}),
			errorExpected: false,
		},
		{
		...
		},
		{
			...
			validationsChecker: makeJsonChecker(map[validationID]validationCheckResult{
				...
				IsPullSecretSet:                     {status: ValidationSuccess, messagePattern: "The pull secret is set"},
				SufficientMastersCount:              {status: ValidationSuccess, messagePattern: "The cluster has a sufficient number of master candidates."},
				IsOcsRequirementsSatisfied:          {status: ValidationFailure, messagePattern: "Insufficient Resources to deploy OCS in Minimal Deployment Mode. A minimum of 3 Disks of minimum 5GB is required.3 Hosts with disks, is required."},
			}),
			errorExpected: false,
		},
		{
