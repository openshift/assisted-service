...
var _ = Describe("Transition tests", func() {
	...
	Context("cancel_installation", func() {
		BeforeEach(func() {
			capi = NewManager(getDefaultConfig(), common.GetTestLog(), db, nil, eventsHandler, uploadClient, nil, mockMetric, nil, nil, operatorsManager, nil, nil, nil, nil)
		})
	...
	Context("complete_installation", func() {
		...
		for i := range tests {
			...
			It(t.name, func() {
				...
				capi = NewManager(getDefaultConfig(), common.GetTestLog(), db, nil, eventsHandler, uploadClient, nil, mockMetric, nil, nil, operatorsManager, ocmClient, mockS3Api, nil, nil)
...
var _ = Describe("Cancel cluster installation", func() {
	...
	BeforeEach(func() {
		...
		uploadClient = uploader.NewClient(&uploader.Config{EnableDataCollection: false}, nil, logrus.New(), nil)
		capi = NewManager(getDefaultConfig(), common.GetTestLog(), db, nil, mockEventsHandler, uploadClient, nil, mockMetric, nil, nil, operatorsManager, nil, nil, nil, nil)
	})
...
var _ = Describe("Reset cluster", func() {
	...
	BeforeEach(func() {
		...
		mockEventsHandler = eventsapi.NewMockHandler(ctrl)
		operatorsManager := operators.NewManager(common.GetTestLog(), nil, operators.Options{}, nil, nil)
		capi = NewManager(getDefaultConfig(), common.GetTestLog(), db, nil, mockEventsHandler, nil, nil, nil, nil, nil, operatorsManager, nil, nil, nil, nil)
	})
...
var _ = Describe("Log Collection - refresh cluster", func() {
	...
	BeforeEach(func() {
		...
		mockMetric = metrics.NewMockAPI(ctrl)
		operatorsManager := operators.NewManager(common.GetTestLog(), nil, operators.Options{}, nil, nil)
		clusterApi = NewManager(logTimeoutConfig(), common.GetTestLog().WithField("pkg", "cluster-monitor"), db, nil,
			mockEvents, nil, mockHostAPI, mockMetric, nil, nil, operatorsManager, nil, nil, nil, nil)
		clusterId = strfmt.UUID(uuid.New().String())
	})
