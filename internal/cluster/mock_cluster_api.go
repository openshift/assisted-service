...
func (mr *MockAPIMockRecorder) RefreshSchedulableMastersForcedTrue(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) RefreshSchedulableMastersForcedTrueWithClusterID(ctx, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
