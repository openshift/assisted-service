...
//go:generate mockgen --build_flags=--mod=mod -package registry -destination mock_providerregistry.generated_go . ProviderRegistry
...
//
//go:generate mockgen --build_flags=--mod=mod -package registry -destination mock_registry.generated_go . Registry
