...
//
//	mockgen --build_flags=--mod=mod -package registry -destination mock_registry.go . Registry
//
...
func (m *MockRegistry) Get(platform *models.Platform) (provider.Provider, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRegistryMockRecorder) Get(platform any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockRegistry)(nil).Get), platform)
}
