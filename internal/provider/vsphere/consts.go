...
const (
	PhCluster          = "clusterplaceholder"
	PhVcenter          = "vcenterplaceholder"
	PhNetwork          = "networkplaceholder"
	PhDefaultDatastore = "defaultdatastoreplaceholder"
	PhUsername         = "usernameplaceholder"
	PhPassword         = "passwordplaceholder"
	PhDatacenter       = "datacenterplaceholder"

	DbFieldVsphere          = "platform_vsphere_username"
