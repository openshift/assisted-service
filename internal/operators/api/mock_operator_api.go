...
//
//	mockgen -package=api -self_package=github.com/openshift/assisted-service/internal/operators/api -destination=mock_operator_api.go . Operator
//
...
func (m *MockOperator) GetBundleLabels(featureIDs []models.FeatureSupportLevelID) []string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBundleLabels", featureIDs)
	ret0, _ := ret[0].([]string)
	return ret0
}

// GetBundleLabels indicates an expected call of GetBundleLabels.
func (mr *MockOperatorMockRecorder) GetBundleLabels(featureIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBundleLabels", reflect.TypeOf((*MockOperator)(nil).GetBundleLabels), featureIDs)
}
