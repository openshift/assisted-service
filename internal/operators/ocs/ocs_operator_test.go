...
var _ = Describe("Ocs Operator Test GetHostRequirements", func() {
	...
	Context("GetHostRequirements", func() {
		table.DescribeTable("passing scenario: get requirements for hosts when ", func(cluster *dbc.Cluster, host *models.Host, expectedResult *models.ClusterHostRequirementsDetails) {
			...
			table.Entry("there are three masters",
				&dbc.Cluster{Cluster: models.Cluster{Hosts: []*models.Host{
		...
		table.DescribeTable("failure scenario: get requirements for hosts when ", func(cluster *dbc.Cluster, host *models.Host, expectedResult error) {
