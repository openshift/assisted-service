...
func (m *MockSpokeK8sClientFactory) ClientAndSetFromSecret(arg0 context.Context, arg1 *v1.Secret) (SpokeK8sClient, *kubernetes.Clientset, error) {
	m.ctrl.T.Helper()
...
func (m *MockSpokeK8sClientFactory) CreateFromSecret(arg0 context.Context, arg1 *v1.Secret) (SpokeK8sClient, error) {
	m.ctrl.T.Helper()
