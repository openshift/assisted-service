...
//
//	mockgen -source=mocks.go -package=dns -destination=mock_dns_vendor.go
//
...
func (mr *MockDNSProviderMockRecorder) CreateRecordSet(recordSetName, recordSetValue any) *gomock.Call {
...
func (mr *MockDNSProviderMockRecorder) DeleteRecordSet(recordSetName, recordSetValue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSProviderMockRecorder) GetRecordSet(recordSetName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSProviderMockRecorder) UpdateRecordSet(recordSetName, recordSetValue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
