...
//
//	mockgen -source=dns.go -package=dns -destination=mock_dns.go
//
...
func (mr *MockDNSApiMockRecorder) CreateDNSRecordSets(ctx, cluster any) *gomock.Call {
...
func (mr *MockDNSApiMockRecorder) DeleteDNSRecordSets(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSApiMockRecorder) GetDNSDomain(clusterName, baseDNSDomainName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSApiMockRecorder) ValidateBaseDNS(domain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSApiMockRecorder) ValidateDNSName(clusterName, baseDNSDomainName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSApiMockRecorder) ValidateDNSRecords(cluster, domain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSProviderFactoryMockRecorder) GetProvider(domain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDNSProviderFactoryMockRecorder) GetProviderByRecordType(domain, recordType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
