...
type SupportLevelFeature interface {
	...
	getSupportLevel(filters SupportLevelFilters) (models.SupportLevel, models.IncompatibilityReason)
...
type SupportLevelOperator interface {
	SupportLevelFeature
	getOperator() api.Operator
}
