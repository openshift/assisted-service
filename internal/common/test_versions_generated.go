...
var testOsImagesByArch = map[string]map[string]testOsImage{
	"arm64": {
		...
		"5.0": {
			...
			URL:     "https://mirror.openshift.com/pub/openshift-v4/aarch64/dependencies/rhcos/pre-release/5.0.0-rc.1/rhcos-5.0.0-rc.1-aarch64-live-iso.aarch64.iso",
		},
	},
	"ppc64le": {
		"4.11": {
		...
		"5.0": {
			Version: "9.8.20260428-0",
			URL:     "https://mirror.openshift.com/pub/openshift-v4/ppc64le/dependencies/rhcos/pre-release/5.0.0-rc.1/rhcos-5.0.0-rc.1-ppc64le-live-iso.ppc64le.iso",
		},
	},
	"s390x": {
		"4.11": {
		...
		"5.0": {
			Version: "9.8.20260428-0",
			URL:     "https://mirror.openshift.com/pub/openshift-v4/s390x/dependencies/rhcos/pre-release/5.0.0-rc.1/rhcos-5.0.0-rc.1-s390x-live-iso.s390x.iso",
		},
	},
	"x86_64": {
		"4.9": {
		...
		"5.0": {
			Version: "9.8.20260428-0",
			URL:     "https://mirror.openshift.com/pub/openshift-v4/x86_64/dependencies/rhcos/pre-release/5.0.0-rc.1/rhcos-5.0.0-rc.1-x86_64-live-iso.x86_64.iso",
		},
	},
}
...
var testReleaseImagesByArch = map[string]map[string]testReleaseImage{
	"arm64": {
		...
		"4.14": {
			Version: "4.14.72",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.14.72-aarch64",
		},
		"4.16": {
			Version: "4.16.69",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.16.69-aarch64",
		},
		"4.17": {
			Version: "4.17.57",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.17.57-aarch64",
		},
		"4.18": {
			Version: "4.18.54",
		...
		"4.20": {
			Version: "4.20.37",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.20.37-aarch64",
		},
		"4.21": {
			Version: "4.21.32",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.21.32-aarch64",
		},
		"4.22": {
			Version: "4.22.13",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.22.13-aarch64",
		},
		"5.0": {
			Version: "5.0.0-rc.1",
			URL:     "quay.io/openshift-release-dev/ocp-release:5.0.0-rc.1-aarch64",
		},
	},
	"multi": {
		"4.11": {
		...
		"4.14": {
			Version: "4.14.72-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.14.72-multi",
		},
		"4.16": {
			Version: "4.16.69-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.16.69-multi",
		},
		"4.17": {
			Version: "4.17.57-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.17.57-multi",
		},
		"4.18": {
			Version: "4.18.54-multi",
		...
		"4.20": {
			Version: "4.20.37-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.20.37-multi",
		},
		"4.21": {
			Version: "4.21.32-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.21.32-multi",
		},
		"4.22": {
			Version: "4.22.13-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.22.13-multi",
		},
		"5.0": {
			Version: "5.0.0-rc.1-multi",
			URL:     "quay.io/openshift-release-dev/ocp-release:5.0.0-rc.1-multi",
		},
	},
	"x86_64": {
		"4.9": {
		...
		"4.13": {
			Version: "4.13.70",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.13.70-x86_64",
		},
		"4.14": {
			Version: "4.14.72",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.14.72-x86_64",
		},
		"4.16": {
			Version: "4.16.69",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.16.69-x86_64",
		},
		"4.17": {
			Version: "4.17.57",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.17.57-x86_64",
		},
		"4.18": {
			Version: "4.18.54",
		...
		"4.20": {
			Version: "4.20.37",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.20.37-x86_64",
		},
		"4.21": {
			Version: "4.21.32",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.21.32-x86_64",
		},
		"4.22": {
			Version: "4.22.13",
			URL:     "quay.io/openshift-release-dev/ocp-release:4.22.13-x86_64",
		},
		"5.0": {
			Version: "5.0.0-rc.1",
			URL:     "quay.io/openshift-release-dev/ocp-release:5.0.0-rc.1-x86_64",
		},
	},
}
