...
type Versions struct {
	...
	KubeconfigGenerator string `envconfig:"KUBECONFIG_GENERATE_IMAGE" default:"quay.io/ocpmetal/assisted-ignition-generator:latest"`
	...
	return operations.NewListComponentVersionsOK().WithPayload(
		&models.ListVersions{
			Versions: models.Versions{
				...
				"assisted-ignition-generator":   h.versions.KubeconfigGenerator,
