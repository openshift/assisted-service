...
//
//	mockgen -source=clients.go -destination=mock_clients.go -package=releasesources
//
...
func (mr *MockopenShiftReleasesAPIClientInterfaceMockRecorder) getReleases(channel, openshiftVersion, cpuArchitecture any) *gomock.Call {
