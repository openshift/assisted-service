...
//
//	mockgen -source=builder.go -package=builder -destination=mock_installcfg.go
//
...
func (mr *MockInstallConfigBuilderMockRecorder) GetInstallConfig(cluster, clusterInfraenvs, rhRootCA any) *gomock.Call {
...
func (mr *MockInstallConfigBuilderMockRecorder) ValidateInstallConfigPatch(cluster, clusterInfraenvs, patch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
