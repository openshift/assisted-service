...
func (b *bareMetalInventory) updateParams(ctx context.Context, params installer.UpdateInfraEnvParams, internalIgnitionConfig *string, mirrorRegistryConfiguration *common.MirrorRegistryConfiguration) installer.UpdateInfraEnvParams {
	log := logutil.FromContext(ctx, b.log)
...
func (b *bareMetalInventory) UpdateInfraEnvInternal(ctx context.Context, params installer.UpdateInfraEnvParams, internalIgnitionConfig *string, mirrorRegistryConfiguration *common.MirrorRegistryConfiguration) (*common.InfraEnv, error) {
	...
	params = b.updateParams(ctx, params, internalIgnitionConfig, mirrorRegistryConfiguration)
