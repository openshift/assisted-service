			...
			Context("V2RegisterCluster", func() {
				...
				Context("RegisterCluster - Multiple-VIPs Support", func() {
					...
					It("Two APIVips and Two IngressVips - IPv6 first and IPv4 second - positive (OCP 4.12+)", func() {
						...
						clusterNetworks := []*models.ClusterNetwork{{Cidr: "2001:db8::/53"}, {Cidr: "10.0.0.0/16"}}
						serviceNetworks := []*models.ServiceNetwork{{Cidr: "2001:db8:1::/64"}, {Cidr: "172.30.0.0/16"}}
						machineNetworks := []*models.MachineNetwork{{Cidr: "2001:db8::/64"}, {Cidr: "8.8.8.0/24"}}
