...
var _ = Describe("cluster", func() {
	...
	Context("Create non HA cluster", func() {
		...
		It("happy flow", func() {
			bm.clusterApi = cluster.NewManager(cluster.Config{}, common.GetTestLog().WithField("pkg", "cluster-monitor"),
				db, nil, mockEvents, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	Context("Update", func() {
		...
		It("update cluster day1 with APIVipDNSName failed", func() {
			...
			bm.clusterApi = cluster.NewManager(cluster.Config{}, common.GetTestLog(), db, nil, mockEvents, nil, nil, nil, nil, mockOperators, nil, nil, nil, nil)
...
var _ = Describe("V2UploadClusterIngressCert test", func() {
	...
	BeforeEach(func() {
		...
		mockOperators := operators.NewMockAPI(ctrl)
		bm.clusterApi = cluster.NewManager(cluster.Config{}, common.GetTestLog().WithField("pkg", "cluster-monitor"),
			db, nil, nil, nil, nil, nil, nil, mockOperators, nil, nil, nil, nil)
		c = common.Cluster{Cluster: models.Cluster{
			ID:               &clusterID,
			OpenshiftVersion: common.TestDefaultConfig.OpenShiftVersion,
			APIVip:           "10.11.12.13",
	...
	Context("Disk encryption", func() {
		...
		It("updating cluster with disk encryption", func() {
			...
			diskEncryptionBm.clusterApi = cluster.NewManager(cluster.Config{}, common.GetTestLog().WithField("pkg", "cluster-monitor"),
				db, nil, mockEvents, nil, nil, nil, nil, mockOperatorManager, nil, nil, nil, nil)
...
var _ = Describe("AMS subscriptions", func() {
	...
	BeforeEach(func() {
		...
		db, dbName = common.PrepareTestDB()
		bm = createInventory(db, cfg)
		bm.clusterApi = cluster.NewManager(cluster.Config{}, common.GetTestLog(), db, nil, mockEvents, nil, nil, nil, nil, nil, nil, nil, nil, nil)
		mockUsageReports()
	})
	...
	Context("With AMS subscriptions", func() {
		...
		It("deregister cluster that don't have 'Reserved' subscriptions", func() {
			...
			bm.clusterApi = cluster.NewManager(cluster.Config{}, common.GetTestLog().WithField("pkg", "cluster-monitor"),
				db, nil, mockEvents, nil, nil, nil, nil, nil, nil, mockS3Client, nil, nil)
			mockClusterRegisterSuccess(true)
			mockAMSSubscription(ctx)
