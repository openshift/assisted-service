...
var _ = Describe("GenerateClusterISO", func() {
	...
	It("success - infra-env", func() {
		...
		mockEvents.EXPECT().AddEvent(gomock.Any(), infraEnvID, nil, models.EventSeverityInfo, "Generated image (Image type is \"full-iso\", SSH public key is not set)", gomock.Any())
		err := bm.generateInfraEnvISOInternal(ctx, infraEnv, models.ImageTypeFullIso)
