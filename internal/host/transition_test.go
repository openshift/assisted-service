...
type validationsChecker struct {
	expected map[internalmodels.HostValidationID]validationCheckResult
}

func (j *validationsChecker) check(validationsStr string) {
	validationRes := make(internalmodels.HostValidationsStatus)
...
func checkValidationInfoIsSorted(vRes internalmodels.HostValidationResults) bool {
...
type validationCheckResult struct {
	status         internalmodels.HostValidationStatus
	messagePattern string
}

func makeJsonChecker(expected map[internalmodels.HostValidationID]validationCheckResult) *validationsChecker {
		...
		for j := range postRebootingStages {
			...
			It(name, func() {
				...
				for _, vRes := range validationRes {
					for _, v := range vRes {
						Expect(v.ID).ToNot(Equal(internalmodels.IsConnected))
						Expect(v.ID).ToNot(Equal(internalmodels.IsNTPSynced))
					}
				}
			})
		}
	...
	Context("Validate host", func() {
		tests := []struct {
		...
		}{
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.IsConnected:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host is connected"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.BelongsToMajorityGroup:                         {status: internalmodels.HostValidationPending, messagePattern: "Machine Network CIDR or Connectivity Majority Groups missing"},
					internalmodels.HasInventory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Valid inventory exists for the host"},
					internalmodels.HasMinCPUCores:                                 {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores"},
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationFailure, messagePattern: "The host is not eligible to participate in Openshift Cluster bec"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role worker"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 8.35 GiB RAM for role worker, found only 150 MiB"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname worker is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.AreLsoRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: "odf is disabled"},
					internalmodels.AreCnvRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "Insufficient memory to deploy OpenShift Virtualization. Required memory is 360 MiB but found 150 MiB"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role master"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 16.15 GiB RAM for role master, found only 100 MiB"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname master is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.AreLsoRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: "odf is disabled"},
					internalmodels.AreCnvRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "Insufficient memory to deploy OpenShift Virtualization. Required memory is 150 MiB but found 100 MiB"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.BelongsToMajorityGroup:                         {status: internalmodels.HostValidationPending, messagePattern: "Machine Network CIDR or Connectivity Majority Groups missing"},
					internalmodels.HasInventory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Valid inventory exists for the host"},
					internalmodels.HasMinCPUCores:                                 {status: internalmodels.HostValidationFailure, messagePattern: "The host is not eligible to participate in Openshift Cluster because the minimum required CPU cores for any role is 2, found only 1"},
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient minimum RAM"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 4 CPU cores for worker role, found only 1"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role worker"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname worker is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					...
					internalmodels.AreLsoRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: "odf is disabled"},
					internalmodels.AreCnvRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "Insufficient CPU to deploy OpenShift Virtualization. Required CPU count is 2 but found 1"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 8 CPU cores for master role, found only 1"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role master"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname master is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					...
					internalmodels.AreLsoRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: "odf is disabled"},
					internalmodels.AreCnvRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "Insufficient CPU to deploy OpenShift Virtualization. Required CPU count is 4 but found 1"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.AreLsoRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: "odf is disabled"},
					internalmodels.AreCnvRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "CPU does not have virtualization support"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
				}),
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role worker"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 9.35 GiB RAM for role worker, found only 1.00 GiB"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname worker is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					...
					internalmodels.AreLsoRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: ""},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationSuccess, messagePattern: "odf is disabled"},
					internalmodels.AreCnvRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "Insufficient memory to deploy OpenShift Virtualization. Required memory is 1384 MiB but found 1024 MiB"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
				}),
	...
	Context("Preparing for installation", func() {
		tests := []struct {
		...
		}{
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			},
			{
			...
			},
			{
				...
				statusInfoChecker: makeValueChecker(statusInfoKnown),
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk is sufficient"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationFailure, messagePattern: "While preparing the previous installation the installation disk speed measurement failed or was found to be insufficient"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationFailure, messagePattern: "While preparing the previous installation the installation disk speed measurement failed or was found to be insufficient"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationFailure, messagePattern: "Failed to fetch container images needed for installation from"},
				}),
				disksInfo:   createDiskInfo("/dev/sda", 0, -1),
		...
		tests := []TransitionTestStruct{
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.IsConnected:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host is disconnected"},
					internalmodels.HasInventory:                                   {status: internalmodels.HostValidationFailure, messagePattern: "Inventory has not been received for the host"},
					internalmodels.HasMinCPUCores:                                 {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory"},
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationFailure, messagePattern: "Machine Network CIDR is undefined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory or role"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory or role"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory or machine network CIDR"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory or platform isn't set"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasInventory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Valid inventory exists for the host"},
					internalmodels.HasMinCPUCores:                                 {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores"},
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationFailure, messagePattern: "The host is not eligible to participate in Openshift Cluster because the minimum required RAM for any role is 8.00 GiB, found only 130 bytes"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationFailure, messagePattern: "No eligible disks were found, please check specific disks to see why they are not eligible"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationFailure, messagePattern: "Machine Network CIDR is undefined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role worker"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 8.00 GiB RAM for role worker, found only 130 bytes"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname  is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory or machine network CIDR"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationFailure, messagePattern: "No eligible disks were found, please check specific disks to see why they are not eligible"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationFailure, messagePattern: "Machine Network CIDR is undefined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 8.00 GiB RAM for role worker, found only 130 bytes"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname  is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationPending, messagePattern: "Missing inventory or machine network CIDR"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role worker"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname  is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationFailure, messagePattern: "Host does not belong to machine network CIDRs. Verify that the host belongs to every CIDR listed under machine networks"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationFailure, messagePattern: "Failed to fetch container images needed for installation from image."},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
				inventory:     workerInventory(),
				errorExpected: false,
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 4 CPU cores for master role, found only 2"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 16.00 GiB RAM for role master, found only 8.00 GiB"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname  is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationFailure, messagePattern: "Host does not belong to machine network CIDRs. Verify that the host belongs to every CIDR listed under machine networks"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role master"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role master"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: " is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationFailure, messagePattern: fmt.Sprintf("Platform %s is allowed only for Single Node OpenShift or user-managed networking", OpenStackPlatform)},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role master"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: " is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationFailure, messagePattern: "Host does not belong to machine network CIDRs"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationFailure, messagePattern: "Host couldn't synchronize with any NTP server"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationFailure, messagePattern: "Failed to fetch container images needed for installation from image."},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.NonOverlappingSubnets:                          {status: internalmodels.HostValidationFailure, messagePattern: "Address network .* appears on multiple interfaces"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.NonOverlappingSubnets:                          {status: internalmodels.HostValidationSuccess, messagePattern: "Host subnets are not overlapping"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.NonOverlappingSubnets:                          {status: internalmodels.HostValidationFailure, messagePattern: "Address networks .* in interface .* and .* in interface .* overlap"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient minimum RAM"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "No Machine Network CIDR needed: User Managed Networking"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role master"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role master"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: " is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "No machine network CIDR validation needed: User Managed Networking"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.BelongsToMajorityGroup:                         {status: internalmodels.HostValidationSuccess, messagePattern: "Host has connectivity to the majority of hosts in the cluster"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
				inventory:             hostutil.GenerateMasterInventory(),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient minimum RAM"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "No Machine Network CIDR needed: Day2 cluster"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role master"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role master"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: " is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "No machine network CIDR validation needed: Day2 cluster"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.BelongsToMajorityGroup:                         {status: internalmodels.HostValidationSuccess, messagePattern: "Day2 host is not required to be connected to other hosts in the cluster"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
					internalmodels.IsDNSWildcardNotConfigured:                     {status: internalmodels.HostValidationSuccess, messagePattern: "DNS wildcard check is not required for day2"},
				}),
				inventory:     hostutil.GenerateMasterInventory(),
				errorExpected: false,
				isDay2:        true,
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "No machine network CIDR validation needed: User Managed Networking"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.BelongsToMajorityGroup:                         {status: internalmodels.HostValidationPending, messagePattern: "Not enough hosts in cluster to calculate connectivity groups"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
				inventory:             hostutil.GenerateMasterInventory(),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "No machine network CIDR validation needed: User Managed Networking"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname .* is allowed"},
					internalmodels.BelongsToMajorityGroup:                         {status: internalmodels.HostValidationFailure, messagePattern: "No connectivity to the majority of hosts in the cluster"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
				inventory:             hostutil.GenerateMasterInventory(),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 4 CPU cores for worker role, found only 2"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role worker"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.IsConnected:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host is connected"},
					internalmodels.HasInventory:                                   {status: internalmodels.HostValidationSuccess, messagePattern: "Valid inventory exists for the host"},
					internalmodels.HasMinCPUCores:                                 {status: internalmodels.HostValidationFailure, messagePattern: "The host is not eligible to participate in Openshift Cluster "},
					internalmodels.HasMinMemory:                                   {status: internalmodels.HostValidationFailure, messagePattern: "The host is not eligible to participate in Openshift Cluster"},
					internalmodels.HasMinValidDisks:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient disk capacity"},
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 8 CPU cores for master role, found only 1"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 16.15 GiB RAM for role master, found only 2.00 GiB"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role master"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role master"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname master-1 is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.IsMachineCidrDefined:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Machine Network CIDR is defined"},
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role worker"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationFailure, messagePattern: "Require at least 8.35 GiB RAM for role worker, found only 8.00 GiB"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Hostname worker-1 is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.AreOdfRequirementsSatisfied:                    {status: internalmodels.HostValidationFailure, messagePattern: "ODF unsupported Host Role for Compact Mode."},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
				}),
				errorExpected:      false,
		...
		for _, hostName := range []string{"localhost", "localhost.localdomain", "localhost4", "localhost4.localdomain4", "localhost6", "localhost6.localdomain6"} {
			tests = append(tests, TransitionTestStruct{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationSuccess, messagePattern: " is unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsHostnameValid:                                {status: internalmodels.HostValidationFailure, messagePattern: fmt.Sprintf("Hostname %s is forbidden", hostName)},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
					internalmodels.SucessfullOrUnknownContainerImagesAvailability: {status: internalmodels.HostValidationSuccess, messagePattern: "All required container images were either pulled successfully or no attempt was made to pull them"},
					internalmodels.SufficientOrUnknownInstallationDiskSpeed:       {status: internalmodels.HostValidationSuccess, messagePattern: "Speed of installation disk has not yet been measured"},
				}),
		...
		tests := []struct {
			...
			},
			{
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					...
					internalmodels.HasCPUCoresForRole:                             {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient CPU cores for role worker"},
					internalmodels.HasMemoryForRole:                               {status: internalmodels.HostValidationSuccess, messagePattern: "Sufficient RAM for role worker"},
					internalmodels.IsHostnameUnique:                               {status: internalmodels.HostValidationFailure, messagePattern: " is not unique in cluster"},
					internalmodels.BelongsToMachineCidr:                           {status: internalmodels.HostValidationSuccess, messagePattern: "Host belongs to all machine network CIDRs"},
					internalmodels.IsPlatformNetworkSettingsValid:                 {status: internalmodels.HostValidationSuccess, messagePattern: "Platform RHEL is allowed"},
					internalmodels.CompatibleWithClusterPlatform:                  {status: internalmodels.HostValidationSuccess, messagePattern: "Host is compatible with cluster platform baremetal"},
					internalmodels.IsNTPSynced:                                    {status: internalmodels.HostValidationSuccess, messagePattern: "Host NTP is synced"},
			...
			It(t.name, func() {
				...
				for id := range t.disabledValidations {
					for _, cat := range validationRes {
						for _, val := range cat {
							if val.ID.String() == id {
								Expect(val.Status).To(Equal(internalmodels.HostValidationDisabled))
	...
	Context("L3 network latency and packet loss validation", func() {
		...
		tests := []struct {
			...
			{name: "known with IPv4 and 3 masters",
				...
				statusInfoChecker:      makeValueChecker(formatStatusInfoFailedValidation(statusInfoKnown)),
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.HasSufficientNetworkLatencyRequirementForRole: {status: internalmodels.HostValidationSuccess, messagePattern: "Network latency requirement has been satisfied."},
					internalmodels.HasSufficientPacketLossRequirementForRole:     {status: internalmodels.HostValidationSuccess, messagePattern: "Packet loss requirement has been satisfied."},
				}),
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.HasSufficientNetworkLatencyRequirementForRole: {status: internalmodels.HostValidationFailure, messagePattern: "Network latency requirements of less than or equals 100.00 ms not met for connectivity between .*? and master-1 \\(200.00 ms\\), master-2 \\(200.00 ms\\)."},
					internalmodels.HasSufficientPacketLossRequirementForRole:     {status: internalmodels.HostValidationFailure, messagePattern: "Packet loss percentage requirement of equals 0.00% not met for connectivity between .*? and master-1 \\(1.00%\\), master-2 \\(1.00%\\)."},
				}),
	...
	Context("Default route", func() {
		...
		tests := []struct {
			...
			{name: "known with default route on IPv4 only",
				...
				statusInfoChecker: makeValueChecker(statusInfoKnown),
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.HasDefaultRoute: {status: internalmodels.HostValidationSuccess, messagePattern: "Host has been configured with at least one default route."},
				}),
			},
			...
			{name: "insufficient with no default route",
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.HasDefaultRoute: {status: internalmodels.HostValidationFailure, messagePattern: "Host has not yet been configured with a default route."},
				}),
			},
			...
			{name: "discovering with pending inventory",
				...
				validationsChecker: makeJsonChecker(map[internalmodels.HostValidationID]validationCheckResult{
					internalmodels.HasDefaultRoute: {status: internalmodels.HostValidationPending, messagePattern: "Missing default routing information."},
				}),
			},
...
var _ = Describe("validationResult sort", func() {
	It("validationResult sort", func() {
		validationResults := []internalmodels.HostValidationResult{
