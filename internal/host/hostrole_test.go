...
var _ = Describe("Suggested-Role on Refresh", func() {
	...
	BeforeEach(func() {
		...
		hapi = NewManager(common.GetTestLog(), db, nil, mockEvents, mockHwValidator, nil, validatorCfg, nil, defaultConfig, nil, operatorsManager, mockProviderRegistry, false, nil, mockVersions, false, monitorConfig)
	})
