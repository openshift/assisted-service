	...
	*/
	...
	Context("Is MTU OK", func() {
		...
		DescribeTable("MTU validations across CMN and UMN", func(validationID validationID, mtuReports []*models.MtuReport, validationStatus ValidationStatus, isUMN bool) {
			...
			Entry("isMtuOKInMachineNetwork (CMN) - Happy flow - MTU reports in the machine network are successful", IsMtuOK, []*models.MtuReport{
			...
			Entry("isMtuOKInMachineNetwork (CMN) - Bad flow - MTU reports in the machine network are unsuccessful", IsMtuOK, []*models.MtuReport{
