...
//
//	mockgen -source=interface.go -package=installercache -destination=mock_installercache.go
//
...
func (mr *MockInstallerCacheMockRecorder) Get(ctx, releaseID, releaseIDMirror, pullSecret, ocRelease, ocpVersion, clusterID any) *gomock.Call {
