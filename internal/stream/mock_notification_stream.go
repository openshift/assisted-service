...
//
//	mockgen -source=notification_stream.go -package=stream -destination=mock_notification_stream.go
//
...
func (mr *MockNotifierMockRecorder) Notify(ctx, notifiable any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
