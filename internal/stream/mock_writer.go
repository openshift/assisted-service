...
//
//	mockgen -source=writer_factory.go -package=stream -destination=mock_writer.go
//
...
func (m *MockStreamWriter) Write(ctx context.Context, key []byte, payload any) error {
	m.ctrl.T.Helper()
...
func (mr *MockStreamWriterMockRecorder) Write(ctx, key, payload any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
