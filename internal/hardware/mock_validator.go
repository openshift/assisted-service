...
//
//	mockgen -source=validator.go -package=hardware -destination=mock_validator.go
//
...
func (m *MockValidator) DiskIsEligible(ctx context.Context, disk *models.Disk, infraEnv *common.InfraEnv, cluster *common.Cluster, host *models.Host, inventory *models.Inventory) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DiskIsEligible", ctx, disk, infraEnv, cluster, host, inventory)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockValidatorMockRecorder) DiskIsEligible(ctx, disk, infraEnv, cluster, host, inventory any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DiskIsEligible", reflect.TypeOf((*MockValidator)(nil).DiskIsEligible), ctx, disk, infraEnv, cluster, host, inventory)
}
...
func (mr *MockValidatorMockRecorder) GetClusterHostRequirements(ctx, cluster, host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) GetHostInstallationPath(host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) GetHostValidDisks(host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) GetInfraEnvHostRequirements(ctx, infraEnv any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) GetInstallationDiskSpeedThresholdMs(ctx, cluster, host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) GetPreflightHardwareRequirements(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) GetPreflightInfraEnvHardwareRequirements(ctx, infraEnv any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) IsValidStorageDeviceType(disk, hostArchitecture, openshiftVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) ListEligibleDisks(inventory any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
