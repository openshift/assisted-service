...
//
//	mockgen --build_flags=--mod=mod -package=controllers -destination=mock_bmo_utils.go . BMOUtils
//
...
func (m *MockBMOUtils) GetIronicIPs() ([]string, error) {
	m.ctrl.T.Helper()
...
func (m *MockBMOUtils) getICCConfig(ctx context.Context) (*ICCConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "getICCConfig", ctx)
...
func (mr *MockBMOUtilsMockRecorder) getICCConfig(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "getICCConfig", reflect.TypeOf((*MockBMOUtils)(nil).getICCConfig), ctx)
}
