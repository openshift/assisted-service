...
var _ = Describe("handleAgentFinalizer", func() {
	...
	It("adds the finalizer if it doesn't exist", func() {
		...
		Expect(res.Requeue).To(BeTrue()) //nolint:staticcheck // Deprecated but require more changes
	})
