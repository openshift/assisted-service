...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstallEnvCondition) DeepCopyInto(out *InstallEnvCondition) {
	*out = *in
	in.LastProbeTime.DeepCopyInto(&out.LastProbeTime)
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstallEnvCondition.
func (in *InstallEnvCondition) DeepCopy() *InstallEnvCondition {
	if in == nil {
		return nil
	}
	out := new(InstallEnvCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstallEnvStatus) DeepCopyInto(out *InstallEnvStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]InstallEnvCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
