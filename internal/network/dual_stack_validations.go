...
func ValidateDualStackPartialUpdate(
	...
	if machineNetworks != nil {
		if err := validateDualStackNetworkConsistency(machineNetworks, expectedStack, "machine_networks"); err != nil {
			return err
		}
	}
	if apiVips != nil {
		if err := validateDualStackNetworkConsistency(apiVips, expectedStack, "api_vips"); err != nil {
			return err
		}
	}
	if ingressVips != nil {
		if err := validateDualStackNetworkConsistency(ingressVips, expectedStack, "ingress_vips"); err != nil {
			return err
		}
	}
	if serviceNetworks != nil {
		if err := validateDualStackNetworkConsistency(serviceNetworks, expectedStack, "service_networks"); err != nil {
			return err
		}
	}
	if clusterNetworks != nil {
		if err := validateDualStackNetworkConsistency(clusterNetworks, expectedStack, "cluster_networks"); err != nil {
			return err
		}
	}
...
func validateDualStackNetworkConsistency(networks interface{}, expectedStack common.PrimaryIPStack, networkType string) error {
