...
func (m *MockManifestsGeneratorAPI) AddNodeIpHint(ctx context.Context, log logrus.FieldLogger, c *common.Cluster) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddNodeIpHint", ctx, log, c)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddNodeIpHint indicates an expected call of AddNodeIpHint.
func (mr *MockManifestsGeneratorAPIMockRecorder) AddNodeIpHint(ctx, log, c interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddNodeIpHint", reflect.TypeOf((*MockManifestsGeneratorAPI)(nil).AddNodeIpHint), ctx, log, c)
}
