...
//
//	mockgen -source=manifests_generator.go -package=network -destination=mock_manifests_generator.go
//
...
func (mr *MockManifestsGeneratorAPIMockRecorder) AddChronyManifest(ctx, log, c any) *gomock.Call {
...
func (mr *MockManifestsGeneratorAPIMockRecorder) AddDiskEncryptionManifest(ctx, log, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManifestsGeneratorAPIMockRecorder) AddDnsmasqForSingleNode(ctx, log, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManifestsGeneratorAPIMockRecorder) AddNicReapply(ctx, log, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManifestsGeneratorAPIMockRecorder) AddSchedulableMastersManifest(ctx, log, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManifestsGeneratorAPIMockRecorder) AddTelemeterManifest(ctx, log, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
