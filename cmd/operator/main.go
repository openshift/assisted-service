...
func getPodIntrospector(log logrus.FieldLogger, mgr manager.Manager) kubernetes.PodIntrospectorInterface {
	introspector, err := kubernetes.NewPodIntrospector(mgr.GetClient())
	if err != nil {
