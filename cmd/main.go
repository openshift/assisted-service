...
import (
	...
	"github.com/openshift/assisted-service/bminventory"
	"github.com/openshift/assisted-service/cluster"
	"github.com/openshift/assisted-service/cluster/validations"
	"github.com/openshift/assisted-service/common"
	"github.com/openshift/assisted-service/connectivity"
	"github.com/openshift/assisted-service/dns"
	"github.com/openshift/assisted-service/domains"
	"github.com/openshift/assisted-service/events"
	eventsapi "github.com/openshift/assisted-service/events/api"
	"github.com/openshift/assisted-service/garbagecollector"
	"github.com/openshift/assisted-service/controller/controllers"
	"github.com/openshift/assisted-service/hardware"
	"github.com/openshift/assisted-service/host"
	"github.com/openshift/assisted-service/host/hostcommands"
	"github.com/openshift/assisted-service/ignition"
	"github.com/openshift/assisted-service/infraenv"
	installcfg "github.com/openshift/assisted-service/installcfg/builder"
	"github.com/openshift/assisted-service/manifests"
	"github.com/openshift/assisted-service/metrics"
	"github.com/openshift/assisted-service/migrations"
	"github.com/openshift/assisted-service/network"
	"github.com/openshift/assisted-service/oc"
	"github.com/openshift/assisted-service/operators"
	"github.com/openshift/assisted-service/operators/handler"
	"github.com/openshift/assisted-service/provider/registry"
	"github.com/openshift/assisted-service/spec"
	"github.com/openshift/assisted-service/usage"
	"github.com/openshift/assisted-service/versions"
