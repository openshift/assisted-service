...
2. Build the new base os image

    ```sh
    # Example with RHCOS
    BASE_OS_IMAGE=https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/pre-release/latest/rhcos-4.6.0-0.nightly-2020-08-26-093617-x86_64-live.x86_64.iso make build-livecd
    ```
3. Generate a new iso-generator image that will use the base os image we just built

    ~~~sh
    make build-assisted-iso-generator-image
    ~~~
