...
type FeatureSupportLevelFeaturesItems0 struct {
	...
	// Enum: [ADDITIONAL_NTP_SOURCE REQUESTED_HOSTNAME PROXY SNO DAY2_HOSTS VIP_AUTO_ALLOC DISK_SELECTION OVN_NETWORK_TYPE SDN_NETWORK_TYPE PLATFORM_SELECTION SCHEDULABLE_MASTERS AUTO_ASSIGN_ROLE CUSTOM_MANIFEST DISK_ENCRYPTION USER_MANAGED_NETWORKING_WITH_VMS ARM64_ARCHITECTURE]
...
const (
	...
	// FeatureSupportLevelFeaturesItems0FeatureIDUSERMANAGEDNETWORKINGWITHVMS captures enum value "USER_MANAGED_NETWORKING_WITH_VMS"
	FeatureSupportLevelFeaturesItems0FeatureIDUSERMANAGEDNETWORKINGWITHVMS string = "USER_MANAGED_NETWORKING_WITH_VMS"
