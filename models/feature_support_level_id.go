...
const (
	...
	// FeatureSupportLevelIDSTRETCHEDCLUSTERS captures enum value "STRETCHED_CLUSTERS"
	FeatureSupportLevelIDSTRETCHEDCLUSTERS FeatureSupportLevelID = "STRETCHED_CLUSTERS"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["SNO","VIP_AUTO_ALLOC","CUSTOM_MANIFEST","SINGLE_NODE_EXPANSION","LVM","ODF","LSO","CNV","MCE","MTV","NUTANIX_INTEGRATION","BAREMETAL_PLATFORM","NONE_PLATFORM","VSPHERE_INTEGRATION","DUAL_STACK_VIPS","CLUSTER_MANAGED_NETWORKING","USER_MANAGED_NETWORKING","MINIMAL_ISO","FULL_ISO","EXTERNAL_PLATFORM_OCI","DUAL_STACK","PLATFORM_MANAGED_NETWORKING","SKIP_MCO_REBOOT","EXTERNAL_PLATFORM","OVN_NETWORK_TYPE","SDN_NETWORK_TYPE","NODE_FEATURE_DISCOVERY","NVIDIA_GPU","PIPELINES","SERVICEMESH","SERVERLESS","OPENSHIFT_AI","STRETCHED_CLUSTERS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
