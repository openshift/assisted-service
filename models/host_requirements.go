...
// Validate validates this host requirements
func (m *HostRequirements) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HostRequirements) validateMaster(formats strfmt.Registry) error {
...
func (m *HostRequirements) validateWorker(formats strfmt.Registry) error {
