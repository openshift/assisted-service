...
var _ = Describe("[kube-api]cluster installation", func() {
	...
	It("Verify NetworkType configuration with IPv6", func() {
		...
		for _, h := range hosts {
			generateDomain(ctx, h, clusterDeploymentSpec.ClusterName, "hive.example.com")
		}
	...
	It("deploy clusterDeployment full install with infraenv in different namespace", func() {
		...
		generateDomain(ctx, host, clusterDeploymentSpec.ClusterName, "hive.example.com")
	...
	It("None SNO deploy clusterDeployment full install", func() {
		...
		generateDomain(ctx, day2Host1, clusterDeploymentSpec.ClusterName, "hive.example.com")
		...
		generateDomain(ctx, day2Host2, clusterDeploymentSpec.ClusterName, "hive.example.com")
