...
const (
	...
	clusterImageSetName                  = "openshift-v4.13.0"
)
...
var (
	imageSetsData = map[string]string{
		"openshift-v4.13.0-arm":   "quay.io/openshift-release-dev/ocp-release:4.13.6-aarch64",
...
var _ = Describe("[kube-api]cluster installation", func() {
	...
	It("[kube-cpu-arch]deploy ClusterDeployment with arm64 architecture", func() {
		...
		armImageSetRef := &hivev1.ClusterImageSetReference{Name: "openshift-v4.13.0-arm"}
