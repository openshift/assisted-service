...
func (t *SubsystemTestContext) WaitForHostValidationStatusHelper(clusterID, infraEnvID, hostID strfmt.UUID, expectedStatus string, hostValidationIDs ...models.HostValidationID) func() bool {
	return func() bool {
		for _, vID := range hostValidationIDs {
			cond, _ := t.IsHostValidationInStatus(clusterID, infraEnvID, hostID, vID, expectedStatus)
			if !cond {
