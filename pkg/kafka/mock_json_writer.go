...
//
//	mockgen -source=json_writer.go -package=kafka -destination=mock_json_writer.go
//
...
func (mr *MockProducerMockRecorder) WriteMessages(ctx any, msgs ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
