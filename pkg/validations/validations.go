...
// ValidateDomainNameFormat has moved to models/dnsvalidation. This stub is intentionally removed
// to avoid cross-package dependencies from models to pkg. Use dnsvalidation.ValidateDomainNameFormat instead.
...
// ValidatePEMCertificate validates a PEM-encoded certificate for:
...
// This is similar to ValidatePEMCertificate but allows expired certificates
// for CA bundles where the signing cert may have expired but the chain is still valid
