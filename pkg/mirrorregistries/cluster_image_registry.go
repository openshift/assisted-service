...
//// generateRegistryCertificateConfigMap creates a ConfigMap CR containing the registry certificate
//// to be created on the spoke cluster and marshals the ConfigMap to JSON
//func generateRegistryCertificateConfigMap(certificate string) ([]byte, error) {
...
//// registry certificate ConfigMap CR if it exists and sets any insecure registries. It then marshals
//// it into JSON.
