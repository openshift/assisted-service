...
//
//	mockgen -source=pullsecret_auth.go -package=ocm -destination=mock_pullsecret_auth.go
//
...
func (mr *MockOCMAuthenticationMockRecorder) AuthenticatePullSecret(ctx, pullSecret any) *gomock.Call {
