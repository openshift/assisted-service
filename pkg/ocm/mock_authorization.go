...
func (mr *MockOCMAuthorizationMockRecorder) AccessReview(ctx, username, action, subscriptionId, resourceType any) *gomock.Call {
...
func (mr *MockOCMAuthorizationMockRecorder) CapabilityReview(ctx, username, capabilityName, capabilityType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
