...
//
//	mockgen -source=leaderelector.go -package=leader -destination=mock_leader_elector.go
//
...
func (mr *MockElectorInterfaceMockRecorder) RunWithLeader(ctx, run any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockElectorInterfaceMockRecorder) StartLeaderElection(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
