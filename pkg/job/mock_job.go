...
func (m *MockAPI) Monitor(ctx context.Context, name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Monitor", ctx, name)
	ret0, _ := ret[0].(error)
	return ret0
}

// Monitor indicates an expected call of Monitor
func (mr *MockAPIMockRecorder) Monitor(ctx, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Monitor", reflect.TypeOf((*MockAPI)(nil).Monitor), ctx, name)
}
