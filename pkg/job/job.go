...
const UploadBaseISOJobName = "upload-base-iso"
const UploadBaseISOImageName = "livecd.iso"
...
func (k *kubeJob) UploadBaseISO() error {
	...
	if err := k.Create(ctx, k.uploadImageJob(UploadBaseISOJobName, UploadBaseISOImageName)); err != nil {
