...
func (m *MockAPI) DeleteObject(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GeneratePresignedDownloadURL(arg0 context.Context, arg1 string, arg2 time.Duration) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GeneratePresignedDownloadURL", arg0, arg1, arg2)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAPIMockRecorder) GeneratePresignedDownloadURL(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GeneratePresignedDownloadURL", reflect.TypeOf((*MockAPI)(nil).GeneratePresignedDownloadURL), arg0, arg1, arg2)
}
