...
type ListOfClusterOperatorsOK struct {
	...
	/*
	  In: Body
	*/
	Payload v1.MonitoredOperatorsList `json:"body,omitempty"`
}
...
func (o *ListOfClusterOperatorsOK) WithPayload(payload v1.MonitoredOperatorsList) *ListOfClusterOperatorsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list of cluster operators o k response
func (o *ListOfClusterOperatorsOK) SetPayload(payload v1.MonitoredOperatorsList) {
	o.Payload = payload
}
...
func (o *ListOfClusterOperatorsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = v1.MonitoredOperatorsList{}
	}
...
func (o *ListOfClusterOperatorsUnauthorized) WithPayload(payload *v1.InfraError) *ListOfClusterOperatorsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list of cluster operators unauthorized response
func (o *ListOfClusterOperatorsUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *ListOfClusterOperatorsForbidden) WithPayload(payload *v1.InfraError) *ListOfClusterOperatorsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list of cluster operators forbidden response
func (o *ListOfClusterOperatorsForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *ListOfClusterOperatorsNotFound) WithPayload(payload *v1.Error) *ListOfClusterOperatorsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list of cluster operators not found response
func (o *ListOfClusterOperatorsNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ListOfClusterOperatorsMethodNotAllowed) WithPayload(payload *v1.Error) *ListOfClusterOperatorsMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list of cluster operators method not allowed response
func (o *ListOfClusterOperatorsMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ListOfClusterOperatorsInternalServerError) WithPayload(payload *v1.Error) *ListOfClusterOperatorsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list of cluster operators internal server error response
func (o *ListOfClusterOperatorsInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
