...
func (o *DownloadClusterISOBadRequest) WithPayload(payload *v1.Error) *DownloadClusterISOBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster i s o bad request response
func (o *DownloadClusterISOBadRequest) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadClusterISOUnauthorized) WithPayload(payload *v1.InfraError) *DownloadClusterISOUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster i s o unauthorized response
func (o *DownloadClusterISOUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DownloadClusterISOForbidden) WithPayload(payload *v1.InfraError) *DownloadClusterISOForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster i s o forbidden response
func (o *DownloadClusterISOForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DownloadClusterISONotFound) WithPayload(payload *v1.Error) *DownloadClusterISONotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster i s o not found response
func (o *DownloadClusterISONotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadClusterISOConflict) WithPayload(payload *v1.Error) *DownloadClusterISOConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster i s o conflict response
func (o *DownloadClusterISOConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadClusterISOInternalServerError) WithPayload(payload *v1.Error) *DownloadClusterISOInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster i s o internal server error response
func (o *DownloadClusterISOInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
