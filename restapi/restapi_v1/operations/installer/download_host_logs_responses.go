...
func (o *DownloadHostLogsUnauthorized) WithPayload(payload *v1.InfraError) *DownloadHostLogsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download host logs unauthorized response
func (o *DownloadHostLogsUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DownloadHostLogsForbidden) WithPayload(payload *v1.InfraError) *DownloadHostLogsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download host logs forbidden response
func (o *DownloadHostLogsForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DownloadHostLogsNotFound) WithPayload(payload *v1.Error) *DownloadHostLogsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download host logs not found response
func (o *DownloadHostLogsNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadHostLogsMethodNotAllowed) WithPayload(payload *v1.Error) *DownloadHostLogsMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download host logs method not allowed response
func (o *DownloadHostLogsMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadHostLogsConflict) WithPayload(payload *v1.Error) *DownloadHostLogsConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download host logs conflict response
func (o *DownloadHostLogsConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadHostLogsInternalServerError) WithPayload(payload *v1.Error) *DownloadHostLogsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download host logs internal server error response
func (o *DownloadHostLogsInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
