...
// CancelInstallationParams contains all the bound params for the cancel installation operation
...
func (o *CancelInstallationParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CancelInstallationParams) validateClusterID(formats strfmt.Registry) error {
