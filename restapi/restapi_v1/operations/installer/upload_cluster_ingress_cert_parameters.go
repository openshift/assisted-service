...
// UploadClusterIngressCertParams contains all the bound params for the upload cluster ingress cert operation
...
type UploadClusterIngressCertParams struct {
	...
	*/
	...
	/*The ingress certificate.
	  ...
	  In: body
	*/
	IngressCertParams v1.IngressCertParams
}
...
func (o *UploadClusterIngressCertParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UploadClusterIngressCertParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *UploadClusterIngressCertParams) bindDiscoveryAgentVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
