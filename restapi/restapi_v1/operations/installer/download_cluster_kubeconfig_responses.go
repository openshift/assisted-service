...
func (o *DownloadClusterKubeconfigUnauthorized) WithPayload(payload *v1.InfraError) *DownloadClusterKubeconfigUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster kubeconfig unauthorized response
func (o *DownloadClusterKubeconfigUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DownloadClusterKubeconfigForbidden) WithPayload(payload *v1.InfraError) *DownloadClusterKubeconfigForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster kubeconfig forbidden response
func (o *DownloadClusterKubeconfigForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DownloadClusterKubeconfigNotFound) WithPayload(payload *v1.Error) *DownloadClusterKubeconfigNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster kubeconfig not found response
func (o *DownloadClusterKubeconfigNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadClusterKubeconfigMethodNotAllowed) WithPayload(payload *v1.Error) *DownloadClusterKubeconfigMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster kubeconfig method not allowed response
func (o *DownloadClusterKubeconfigMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadClusterKubeconfigConflict) WithPayload(payload *v1.Error) *DownloadClusterKubeconfigConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster kubeconfig conflict response
func (o *DownloadClusterKubeconfigConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DownloadClusterKubeconfigInternalServerError) WithPayload(payload *v1.Error) *DownloadClusterKubeconfigInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download cluster kubeconfig internal server error response
func (o *DownloadClusterKubeconfigInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
