...
func (o *GenerateClusterISOCreated) WithPayload(payload *v1.Cluster) *GenerateClusterISOCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o created response
func (o *GenerateClusterISOCreated) SetPayload(payload *v1.Cluster) {
	o.Payload = payload
}
...
func (o *GenerateClusterISOBadRequest) WithPayload(payload *v1.Error) *GenerateClusterISOBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o bad request response
func (o *GenerateClusterISOBadRequest) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GenerateClusterISOUnauthorized) WithPayload(payload *v1.InfraError) *GenerateClusterISOUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o unauthorized response
func (o *GenerateClusterISOUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GenerateClusterISOForbidden) WithPayload(payload *v1.InfraError) *GenerateClusterISOForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o forbidden response
func (o *GenerateClusterISOForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GenerateClusterISONotFound) WithPayload(payload *v1.Error) *GenerateClusterISONotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o not found response
func (o *GenerateClusterISONotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GenerateClusterISOMethodNotAllowed) WithPayload(payload *v1.Error) *GenerateClusterISOMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o method not allowed response
func (o *GenerateClusterISOMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GenerateClusterISOConflict) WithPayload(payload *v1.Error) *GenerateClusterISOConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o conflict response
func (o *GenerateClusterISOConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GenerateClusterISOInternalServerError) WithPayload(payload *v1.Error) *GenerateClusterISOInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the generate cluster i s o internal server error response
func (o *GenerateClusterISOInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
