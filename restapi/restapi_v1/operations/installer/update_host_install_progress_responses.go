...
func (o *UpdateHostInstallProgressUnauthorized) WithPayload(payload *v1.InfraError) *UpdateHostInstallProgressUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update host install progress unauthorized response
func (o *UpdateHostInstallProgressUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *UpdateHostInstallProgressForbidden) WithPayload(payload *v1.InfraError) *UpdateHostInstallProgressForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update host install progress forbidden response
func (o *UpdateHostInstallProgressForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *UpdateHostInstallProgressNotFound) WithPayload(payload *v1.Error) *UpdateHostInstallProgressNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update host install progress not found response
func (o *UpdateHostInstallProgressNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UpdateHostInstallProgressMethodNotAllowed) WithPayload(payload *v1.Error) *UpdateHostInstallProgressMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update host install progress method not allowed response
func (o *UpdateHostInstallProgressMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UpdateHostInstallProgressInternalServerError) WithPayload(payload *v1.Error) *UpdateHostInstallProgressInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update host install progress internal server error response
func (o *UpdateHostInstallProgressInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UpdateHostInstallProgressServiceUnavailable) WithPayload(payload *v1.Error) *UpdateHostInstallProgressServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update host install progress service unavailable response
func (o *UpdateHostInstallProgressServiceUnavailable) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
