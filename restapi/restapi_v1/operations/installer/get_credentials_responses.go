...
type GetCredentialsOK struct {
	...
	/*
	  In: Body
	*/
	Payload *v1.Credentials `json:"body,omitempty"`
}
...
func (o *GetCredentialsOK) WithPayload(payload *v1.Credentials) *GetCredentialsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials o k response
func (o *GetCredentialsOK) SetPayload(payload *v1.Credentials) {
	o.Payload = payload
}
...
func (o *GetCredentialsUnauthorized) WithPayload(payload *v1.InfraError) *GetCredentialsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials unauthorized response
func (o *GetCredentialsUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GetCredentialsForbidden) WithPayload(payload *v1.InfraError) *GetCredentialsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials forbidden response
func (o *GetCredentialsForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GetCredentialsNotFound) WithPayload(payload *v1.Error) *GetCredentialsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials not found response
func (o *GetCredentialsNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetCredentialsMethodNotAllowed) WithPayload(payload *v1.Error) *GetCredentialsMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials method not allowed response
func (o *GetCredentialsMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetCredentialsConflict) WithPayload(payload *v1.Error) *GetCredentialsConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials conflict response
func (o *GetCredentialsConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetCredentialsInternalServerError) WithPayload(payload *v1.Error) *GetCredentialsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get credentials internal server error response
func (o *GetCredentialsInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
