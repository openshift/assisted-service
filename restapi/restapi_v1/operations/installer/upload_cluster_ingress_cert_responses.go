...
func (o *UploadClusterIngressCertBadRequest) WithPayload(payload *v1.Error) *UploadClusterIngressCertBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert bad request response
func (o *UploadClusterIngressCertBadRequest) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UploadClusterIngressCertUnauthorized) WithPayload(payload *v1.InfraError) *UploadClusterIngressCertUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert unauthorized response
func (o *UploadClusterIngressCertUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *UploadClusterIngressCertForbidden) WithPayload(payload *v1.InfraError) *UploadClusterIngressCertForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert forbidden response
func (o *UploadClusterIngressCertForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *UploadClusterIngressCertNotFound) WithPayload(payload *v1.Error) *UploadClusterIngressCertNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert not found response
func (o *UploadClusterIngressCertNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UploadClusterIngressCertMethodNotAllowed) WithPayload(payload *v1.Error) *UploadClusterIngressCertMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert method not allowed response
func (o *UploadClusterIngressCertMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UploadClusterIngressCertInternalServerError) WithPayload(payload *v1.Error) *UploadClusterIngressCertInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert internal server error response
func (o *UploadClusterIngressCertInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *UploadClusterIngressCertServiceUnavailable) WithPayload(payload *v1.Error) *UploadClusterIngressCertServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload cluster ingress cert service unavailable response
func (o *UploadClusterIngressCertServiceUnavailable) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
