...
// UpdateHostInstallerArgsParams contains all the bound params for the update host installer args operation
// typically these are obtained from a http.Request
//
// swagger:parameters UpdateHostInstallerArgs
...
//
// To ensure default values, the struct must have been initialized with NewUpdateHostInstallerArgsParams() beforehand.
func (o *UpdateHostInstallerArgsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body v1.InstallerArgsParams
...
func (o *UpdateHostInstallerArgsParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateHostInstallerArgsParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *UpdateHostInstallerArgsParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateHostInstallerArgsParams) validateHostID(formats strfmt.Registry) error {
