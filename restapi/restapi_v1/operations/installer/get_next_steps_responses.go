...
type GetNextStepsOK struct {
	...
	/*
	  In: Body
	*/
	Payload *v1.Steps `json:"body,omitempty"`
}
...
func (o *GetNextStepsOK) WithPayload(payload *v1.Steps) *GetNextStepsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps o k response
func (o *GetNextStepsOK) SetPayload(payload *v1.Steps) {
	o.Payload = payload
}
...
func (o *GetNextStepsUnauthorized) WithPayload(payload *v1.InfraError) *GetNextStepsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps unauthorized response
func (o *GetNextStepsUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GetNextStepsForbidden) WithPayload(payload *v1.InfraError) *GetNextStepsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps forbidden response
func (o *GetNextStepsForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GetNextStepsNotFound) WithPayload(payload *v1.Error) *GetNextStepsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps not found response
func (o *GetNextStepsNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetNextStepsMethodNotAllowed) WithPayload(payload *v1.Error) *GetNextStepsMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps method not allowed response
func (o *GetNextStepsMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetNextStepsInternalServerError) WithPayload(payload *v1.Error) *GetNextStepsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps internal server error response
func (o *GetNextStepsInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetNextStepsServiceUnavailable) WithPayload(payload *v1.Error) *GetNextStepsServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get next steps service unavailable response
func (o *GetNextStepsServiceUnavailable) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
