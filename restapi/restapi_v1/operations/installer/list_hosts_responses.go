...
type ListHostsOK struct {
	...
	/*
	  In: Body
	*/
	Payload v1.HostList `json:"body,omitempty"`
}
...
func (o *ListHostsOK) WithPayload(payload v1.HostList) *ListHostsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list hosts o k response
func (o *ListHostsOK) SetPayload(payload v1.HostList) {
	o.Payload = payload
}
...
func (o *ListHostsUnauthorized) WithPayload(payload *v1.InfraError) *ListHostsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list hosts unauthorized response
func (o *ListHostsUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *ListHostsForbidden) WithPayload(payload *v1.InfraError) *ListHostsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list hosts forbidden response
func (o *ListHostsForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *ListHostsMethodNotAllowed) WithPayload(payload *v1.Error) *ListHostsMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list hosts method not allowed response
func (o *ListHostsMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ListHostsInternalServerError) WithPayload(payload *v1.Error) *ListHostsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list hosts internal server error response
func (o *ListHostsInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ListHostsServiceUnavailable) WithPayload(payload *v1.Error) *ListHostsServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list hosts service unavailable response
func (o *ListHostsServiceUnavailable) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
