...
func (o *ResetClusterAccepted) WithPayload(payload *v1.Cluster) *ResetClusterAccepted {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster accepted response
func (o *ResetClusterAccepted) SetPayload(payload *v1.Cluster) {
	o.Payload = payload
}
...
func (o *ResetClusterUnauthorized) WithPayload(payload *v1.InfraError) *ResetClusterUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster unauthorized response
func (o *ResetClusterUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *ResetClusterForbidden) WithPayload(payload *v1.InfraError) *ResetClusterForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster forbidden response
func (o *ResetClusterForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *ResetClusterNotFound) WithPayload(payload *v1.Error) *ResetClusterNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster not found response
func (o *ResetClusterNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ResetClusterMethodNotAllowed) WithPayload(payload *v1.Error) *ResetClusterMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster method not allowed response
func (o *ResetClusterMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ResetClusterConflict) WithPayload(payload *v1.Error) *ResetClusterConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster conflict response
func (o *ResetClusterConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *ResetClusterInternalServerError) WithPayload(payload *v1.Error) *ResetClusterInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the reset cluster internal server error response
func (o *ResetClusterInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
