...
func (o *GetHostOK) WithPayload(payload *v1.Host) *GetHostOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host o k response
func (o *GetHostOK) SetPayload(payload *v1.Host) {
	o.Payload = payload
}
...
func (o *GetHostUnauthorized) WithPayload(payload *v1.InfraError) *GetHostUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host unauthorized response
func (o *GetHostUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GetHostForbidden) WithPayload(payload *v1.InfraError) *GetHostForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host forbidden response
func (o *GetHostForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *GetHostNotFound) WithPayload(payload *v1.Error) *GetHostNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host not found response
func (o *GetHostNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetHostMethodNotAllowed) WithPayload(payload *v1.Error) *GetHostMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host method not allowed response
func (o *GetHostMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *GetHostInternalServerError) WithPayload(payload *v1.Error) *GetHostInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get host internal server error response
func (o *GetHostInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
