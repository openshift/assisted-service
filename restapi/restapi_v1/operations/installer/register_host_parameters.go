...
type RegisterHostParams struct {
	...
	*/
	...
	/*The description of the host being registered.
	  ...
	  In: body
	*/
	NewHostParams *v1.HostCreateParams
}
...
func (o *RegisterHostParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RegisterHostParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *RegisterHostParams) bindDiscoveryAgentVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
