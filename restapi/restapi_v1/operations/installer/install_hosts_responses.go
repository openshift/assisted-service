...
func (o *InstallHostsAccepted) WithPayload(payload *v1.Cluster) *InstallHostsAccepted {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts accepted response
func (o *InstallHostsAccepted) SetPayload(payload *v1.Cluster) {
	o.Payload = payload
}
...
func (o *InstallHostsBadRequest) WithPayload(payload *v1.Error) *InstallHostsBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts bad request response
func (o *InstallHostsBadRequest) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *InstallHostsUnauthorized) WithPayload(payload *v1.InfraError) *InstallHostsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts unauthorized response
func (o *InstallHostsUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *InstallHostsForbidden) WithPayload(payload *v1.InfraError) *InstallHostsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts forbidden response
func (o *InstallHostsForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *InstallHostsNotFound) WithPayload(payload *v1.Error) *InstallHostsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts not found response
func (o *InstallHostsNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *InstallHostsMethodNotAllowed) WithPayload(payload *v1.Error) *InstallHostsMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts method not allowed response
func (o *InstallHostsMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *InstallHostsConflict) WithPayload(payload *v1.Error) *InstallHostsConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts conflict response
func (o *InstallHostsConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *InstallHostsInternalServerError) WithPayload(payload *v1.Error) *InstallHostsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the install hosts internal server error response
func (o *InstallHostsInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
