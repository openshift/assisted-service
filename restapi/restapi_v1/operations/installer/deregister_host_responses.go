...
func (o *DeregisterHostBadRequest) WithPayload(payload *v1.Error) *DeregisterHostBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deregister host bad request response
func (o *DeregisterHostBadRequest) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DeregisterHostUnauthorized) WithPayload(payload *v1.InfraError) *DeregisterHostUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deregister host unauthorized response
func (o *DeregisterHostUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DeregisterHostForbidden) WithPayload(payload *v1.InfraError) *DeregisterHostForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deregister host forbidden response
func (o *DeregisterHostForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *DeregisterHostNotFound) WithPayload(payload *v1.Error) *DeregisterHostNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deregister host not found response
func (o *DeregisterHostNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DeregisterHostMethodNotAllowed) WithPayload(payload *v1.Error) *DeregisterHostMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deregister host method not allowed response
func (o *DeregisterHostMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *DeregisterHostInternalServerError) WithPayload(payload *v1.Error) *DeregisterHostInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deregister host internal server error response
func (o *DeregisterHostInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
