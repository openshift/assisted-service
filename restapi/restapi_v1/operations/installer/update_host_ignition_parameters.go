...
// UpdateHostIgnitionParams contains all the bound params for the update host ignition operation
// typically these are obtained from a http.Request
//
// swagger:parameters UpdateHostIgnition
...
//
// To ensure default values, the struct must have been initialized with NewUpdateHostIgnitionParams() beforehand.
func (o *UpdateHostIgnitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body v1.HostIgnitionParams
...
func (o *UpdateHostIgnitionParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateHostIgnitionParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *UpdateHostIgnitionParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateHostIgnitionParams) validateHostID(formats strfmt.Registry) error {
