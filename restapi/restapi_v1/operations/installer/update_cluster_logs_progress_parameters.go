...
// UpdateClusterLogsProgressParams contains all the bound params for the update cluster logs progress operation
// typically these are obtained from a http.Request
//
// swagger:parameters UpdateClusterLogsProgress
...
//
// To ensure default values, the struct must have been initialized with NewUpdateClusterLogsProgressParams() beforehand.
func (o *UpdateClusterLogsProgressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateClusterLogsProgressParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateClusterLogsProgressParams) validateClusterID(formats strfmt.Registry) error {
