...
func (o *CancelInstallationAccepted) WithPayload(payload *v1.Cluster) *CancelInstallationAccepted {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation accepted response
func (o *CancelInstallationAccepted) SetPayload(payload *v1.Cluster) {
	o.Payload = payload
}
...
func (o *CancelInstallationUnauthorized) WithPayload(payload *v1.InfraError) *CancelInstallationUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation unauthorized response
func (o *CancelInstallationUnauthorized) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *CancelInstallationForbidden) WithPayload(payload *v1.InfraError) *CancelInstallationForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation forbidden response
func (o *CancelInstallationForbidden) SetPayload(payload *v1.InfraError) {
	o.Payload = payload
}
...
func (o *CancelInstallationNotFound) WithPayload(payload *v1.Error) *CancelInstallationNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation not found response
func (o *CancelInstallationNotFound) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *CancelInstallationMethodNotAllowed) WithPayload(payload *v1.Error) *CancelInstallationMethodNotAllowed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation method not allowed response
func (o *CancelInstallationMethodNotAllowed) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *CancelInstallationConflict) WithPayload(payload *v1.Error) *CancelInstallationConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation conflict response
func (o *CancelInstallationConflict) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
...
func (o *CancelInstallationInternalServerError) WithPayload(payload *v1.Error) *CancelInstallationInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the cancel installation internal server error response
func (o *CancelInstallationInternalServerError) SetPayload(payload *v1.Error) {
	o.Payload = payload
}
