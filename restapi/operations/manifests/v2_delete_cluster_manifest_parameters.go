...
// V2DeleteClusterManifestParams contains all the bound params for the v2 delete cluster manifest operation
...
//
// To ensure default values, the struct must have been initialized with NewV2DeleteClusterManifestParams() beforehand.
func (o *V2DeleteClusterManifestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2DeleteClusterManifestParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2DeleteClusterManifestParams) bindFileName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *V2DeleteClusterManifestParams) bindFolder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewV2DeleteClusterManifestParams()
		return nil
	}
	o.Folder = &raw
