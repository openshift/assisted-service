...
// DownloadClusterManifestParams contains all the bound params for the download cluster manifest operation
// typically these are obtained from a http.Request
//
// swagger:parameters DownloadClusterManifest
...
//
// To ensure default values, the struct must have been initialized with NewDownloadClusterManifestParams() beforehand.
func (o *DownloadClusterManifestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DownloadClusterManifestParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadClusterManifestParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *DownloadClusterManifestParams) bindFileName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DownloadClusterManifestParams) bindFolder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDownloadClusterManifestParams()
		return nil
	}
	o.Folder = &raw
...
func (o *DownloadClusterManifestParams) validateFolder(formats strfmt.Registry) error {
