...
// ReportMonitoredOperatorStatusParams contains all the bound params for the report monitored operator status operation
// typically these are obtained from a http.Request
//
// swagger:parameters ReportMonitoredOperatorStatus
...
//
// To ensure default values, the struct must have been initialized with NewReportMonitoredOperatorStatusParams() beforehand.
func (o *ReportMonitoredOperatorStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReportMonitoredOperatorStatusParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReportMonitoredOperatorStatusParams) validateClusterID(formats strfmt.Registry) error {
