...
func (o *DeregisterHostURL) Build() (*url.URL, error) {
	...
	var _path = "/clusters/{clusterId}/hosts/{hostId}"
	...
	if hostID != "" {
		...
		return nil, errors.New("hostId is required on DeregisterHostURL")
	}
...
func (o *DeregisterHostURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeregisterHostURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeregisterHostURL")
	}
