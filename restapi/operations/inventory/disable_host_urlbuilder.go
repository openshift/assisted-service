...
func (o *DisableHostURL) Build() (*url.URL, error) {
	...
	var _path = "/clusters/{clusterId}/hosts/{hostId}/actions/enable"
	...
	if hostID != "" {
		...
		return nil, errors.New("hostId is required on DisableHostURL")
	}
...
func (o *DisableHostURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DisableHostURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DisableHostURL")
	}
