...
// RegisterNodeParams contains all the bound params for the register node operation
// typically these are obtained from a http.Request
//
// swagger:parameters RegisterNode
...
//
// To ensure default values, the struct must have been initialized with NewRegisterNodeParams() beforehand.
func (o *RegisterNodeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
