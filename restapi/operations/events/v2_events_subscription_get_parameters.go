...
// V2EventsSubscriptionGetParams contains all the bound params for the v2 events subscription get operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2EventsSubscriptionGet
...
//
// To ensure default values, the struct must have been initialized with NewV2EventsSubscriptionGetParams() beforehand.
func (o *V2EventsSubscriptionGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2EventsSubscriptionGetParams) bindSubscriptionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2EventsSubscriptionGetParams) validateSubscriptionID(formats strfmt.Registry) error {
