...
// V2GetHostParams contains all the bound params for the v2 get host operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2GetHost
...
//
// To ensure default values, the struct must have been initialized with NewV2GetHostParams() beforehand.
func (o *V2GetHostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2GetHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2GetHostParams) validateHostID(formats strfmt.Registry) error {
...
func (o *V2GetHostParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2GetHostParams) validateInfraEnvID(formats strfmt.Registry) error {
