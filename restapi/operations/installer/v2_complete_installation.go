...
type V2CompleteInstallationHandlerFunc func(V2CompleteInstallationParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn V2CompleteInstallationHandlerFunc) Handle(params V2CompleteInstallationParams, principal any) middleware.Responder {
...
type V2CompleteInstallationHandler interface {
	Handle(V2CompleteInstallationParams, any) middleware.Responder
}
