...
// GetInfraEnvParams contains all the bound params for the get infra env operation
...
//
// To ensure default values, the struct must have been initialized with NewGetInfraEnvParams() beforehand.
func (o *GetInfraEnvParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetInfraEnvParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
