...
func NewV2GetPreflightRequirements(ctx *middleware.Context, handler V2GetPreflightRequirementsHandler) *V2GetPreflightRequirements {
...
type V2GetPreflightRequirements struct {
	...
	Handler V2GetPreflightRequirementsHandler
}

func (o *V2GetPreflightRequirements) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewV2GetPreflightRequirementsParams()
