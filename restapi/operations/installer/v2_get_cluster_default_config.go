...
type V2GetClusterDefaultConfigHandlerFunc func(V2GetClusterDefaultConfigParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn V2GetClusterDefaultConfigHandlerFunc) Handle(params V2GetClusterDefaultConfigParams, principal any) middleware.Responder {
...
type V2GetClusterDefaultConfigHandler interface {
	Handle(V2GetClusterDefaultConfigParams, any) middleware.Responder
}
