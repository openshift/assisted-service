...
// DownloadInfraEnvDiscoveryImageHeadersParams contains all the bound params for the download infra env discovery image headers operation
// typically these are obtained from a http.Request
//
// swagger:parameters DownloadInfraEnvDiscoveryImageHeaders
...
//
// To ensure default values, the struct must have been initialized with NewDownloadInfraEnvDiscoveryImageHeadersParams() beforehand.
func (o *DownloadInfraEnvDiscoveryImageHeadersParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DownloadInfraEnvDiscoveryImageHeadersParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadInfraEnvDiscoveryImageHeadersParams) validateInfraEnvID(formats strfmt.Registry) error {
