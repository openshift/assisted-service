...
// V2GetClusterInstallConfigParams contains all the bound params for the v2 get cluster install config operation
...
//
// To ensure default values, the struct must have been initialized with NewV2GetClusterInstallConfigParams() beforehand.
func (o *V2GetClusterInstallConfigParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2GetClusterInstallConfigParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
