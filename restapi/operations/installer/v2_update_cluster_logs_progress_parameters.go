...
// V2UpdateClusterLogsProgressParams contains all the bound params for the v2 update cluster logs progress operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2UpdateClusterLogsProgress
...
//
// To ensure default values, the struct must have been initialized with NewV2UpdateClusterLogsProgressParams() beforehand.
func (o *V2UpdateClusterLogsProgressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2UpdateClusterLogsProgressParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2UpdateClusterLogsProgressParams) validateClusterID(formats strfmt.Registry) error {
