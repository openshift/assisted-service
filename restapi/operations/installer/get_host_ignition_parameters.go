...
// GetHostIgnitionParams contains all the bound params for the get host ignition operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetHostIgnition
...
//
// To ensure default values, the struct must have been initialized with NewGetHostIgnitionParams() beforehand.
func (o *GetHostIgnitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHostIgnitionParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHostIgnitionParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *GetHostIgnitionParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHostIgnitionParams) validateHostID(formats strfmt.Registry) error {
