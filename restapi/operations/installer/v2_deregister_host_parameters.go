...
// V2DeregisterHostParams contains all the bound params for the v2 deregister host operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2DeregisterHost
...
//
// To ensure default values, the struct must have been initialized with NewV2DeregisterHostParams() beforehand.
func (o *V2DeregisterHostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2DeregisterHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2DeregisterHostParams) validateHostID(formats strfmt.Registry) error {
...
func (o *V2DeregisterHostParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2DeregisterHostParams) validateInfraEnvID(formats strfmt.Registry) error {
