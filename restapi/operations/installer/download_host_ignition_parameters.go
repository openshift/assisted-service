...
// DownloadHostIgnitionParams contains all the bound params for the download host ignition operation
// typically these are obtained from a http.Request
//
// swagger:parameters DownloadHostIgnition
...
//
// To ensure default values, the struct must have been initialized with NewDownloadHostIgnitionParams() beforehand.
func (o *DownloadHostIgnitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DownloadHostIgnitionParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadHostIgnitionParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *DownloadHostIgnitionParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DownloadHostIgnitionParams) validateHostID(formats strfmt.Registry) error {
