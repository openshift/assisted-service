...
// V2GetCredentialsParams contains all the bound params for the v2 get credentials operation
...
//
// To ensure default values, the struct must have been initialized with NewV2GetCredentialsParams() beforehand.
func (o *V2GetCredentialsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2GetCredentialsParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
