...
// V2UpdateClusterUISettingsParams contains all the bound params for the v2 update cluster UI settings operation
...
//
// To ensure default values, the struct must have been initialized with NewV2UpdateClusterUISettingsParams() beforehand.
func (o *V2UpdateClusterUISettingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2UpdateClusterUISettingsParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
