...
// ResetHostValidationParams contains all the bound params for the reset host validation operation
// typically these are obtained from a http.Request
//
// swagger:parameters ResetHostValidation
...
//
// To ensure default values, the struct must have been initialized with NewResetHostValidationParams() beforehand.
func (o *ResetHostValidationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ResetHostValidationParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ResetHostValidationParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *ResetHostValidationParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ResetHostValidationParams) validateHostID(formats strfmt.Registry) error {
...
func (o *ResetHostValidationParams) bindValidationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
