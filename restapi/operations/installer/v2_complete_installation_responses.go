...
func (o *V2CompleteInstallationServiceUnavailable) WithPayload(payload string) *V2CompleteInstallationServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the v2 complete installation service unavailable response
func (o *V2CompleteInstallationServiceUnavailable) SetPayload(payload string) {
	o.Payload = payload
}
