...
// GetDetailedSupportedFeaturesParams contains all the bound params for the get detailed supported features operation
...
//
// To ensure default values, the struct must have been initialized with NewGetDetailedSupportedFeaturesParams() beforehand.
func (o *GetDetailedSupportedFeaturesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDetailedSupportedFeaturesParams) bindCPUArchitecture(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetDetailedSupportedFeaturesParams()
		return nil
	}
...
func (o *GetDetailedSupportedFeaturesParams) bindExternalPlatformName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetDetailedSupportedFeaturesParams) bindOpenshiftVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetDetailedSupportedFeaturesParams) bindPlatformType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
