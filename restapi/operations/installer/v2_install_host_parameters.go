...
// V2InstallHostParams contains all the bound params for the v2 install host operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2InstallHost
...
//
// To ensure default values, the struct must have been initialized with NewV2InstallHostParams() beforehand.
func (o *V2InstallHostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2InstallHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2InstallHostParams) validateHostID(formats strfmt.Registry) error {
...
func (o *V2InstallHostParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2InstallHostParams) validateInfraEnvID(formats strfmt.Registry) error {
