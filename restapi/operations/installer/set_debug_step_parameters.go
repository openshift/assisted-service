...
func (o *SetDebugStepParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SetDebugStepParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *SetDebugStepParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SetDebugStepParams) validateHostID(formats strfmt.Registry) error {
