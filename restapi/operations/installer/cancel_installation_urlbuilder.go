...
func (o *CancelInstallationURL) Build() (*url.URL, error) {
	...
	if clusterID != "" {
		...
		return nil, errors.New("clusterId is required on CancelInstallationURL")
	}
...
func (o *CancelInstallationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CancelInstallationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CancelInstallationURL")
	}
