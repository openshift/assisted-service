...
// ResetClusterParams contains all the bound params for the reset cluster operation
...
func (o *ResetClusterParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ResetClusterParams) validateClusterID(formats strfmt.Registry) error {
