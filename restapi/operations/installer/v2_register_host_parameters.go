...
func (o *V2RegisterHostParams) bindXHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2RegisterHostParams) validateXHostID(formats strfmt.Registry) error {
