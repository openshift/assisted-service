...
// V2ResetHostParams contains all the bound params for the v2 reset host operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2ResetHost
...
//
// To ensure default values, the struct must have been initialized with NewV2ResetHostParams() beforehand.
func (o *V2ResetHostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2ResetHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2ResetHostParams) validateHostID(formats strfmt.Registry) error {
...
func (o *V2ResetHostParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2ResetHostParams) validateInfraEnvID(formats strfmt.Registry) error {
