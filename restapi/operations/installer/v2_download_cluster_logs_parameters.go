...
// V2DownloadClusterLogsParams contains all the bound params for the v2 download cluster logs operation
...
//
// To ensure default values, the struct must have been initialized with NewV2DownloadClusterLogsParams() beforehand.
func (o *V2DownloadClusterLogsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2DownloadClusterLogsParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2DownloadClusterLogsParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2DownloadClusterLogsParams) bindLogsType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
