...
func (o *V2PostStepReplyServiceUnavailable) WithPayload(payload string) *V2PostStepReplyServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the v2 post step reply service unavailable response
func (o *V2PostStepReplyServiceUnavailable) SetPayload(payload string) {
	o.Payload = payload
}
