...
// V2DownloadClusterCredentialsParams contains all the bound params for the v2 download cluster credentials operation
...
//
// To ensure default values, the struct must have been initialized with NewV2DownloadClusterCredentialsParams() beforehand.
func (o *V2DownloadClusterCredentialsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2DownloadClusterCredentialsParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2DownloadClusterCredentialsParams) bindFileName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
