...
// DisableHostParams contains all the bound params for the disable host operation
...
func (o *DisableHostParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DisableHostParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *DisableHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DisableHostParams) validateHostID(formats strfmt.Registry) error {
