...
// DownloadMinimalInitrdParams contains all the bound params for the download minimal initrd operation
...
//
// To ensure default values, the struct must have been initialized with NewDownloadMinimalInitrdParams() beforehand.
func (o *DownloadMinimalInitrdParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DownloadMinimalInitrdParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
