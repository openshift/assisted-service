...
// V2RegisterClusterParams contains all the bound params for the v2 register cluster operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2RegisterCluster
...
//
// To ensure default values, the struct must have been initialized with NewV2RegisterClusterParams() beforehand.
func (o *V2RegisterClusterParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
