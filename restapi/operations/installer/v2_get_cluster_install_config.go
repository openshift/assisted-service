...
func NewV2GetClusterInstallConfig(ctx *middleware.Context, handler V2GetClusterInstallConfigHandler) *V2GetClusterInstallConfig {
...
type V2GetClusterInstallConfig struct {
	...
	Handler V2GetClusterInstallConfigHandler
}

func (o *V2GetClusterInstallConfig) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewV2GetClusterInstallConfigParams()
