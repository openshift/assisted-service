...
// ResetHostParams contains all the bound params for the reset host operation
// typically these are obtained from a http.Request
//
// swagger:parameters ResetHost
...
//
// To ensure default values, the struct must have been initialized with NewResetHostParams() beforehand.
func (o *ResetHostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ResetHostParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ResetHostParams) validateClusterID(formats strfmt.Registry) error {
...
func (o *ResetHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ResetHostParams) validateHostID(formats strfmt.Registry) error {
