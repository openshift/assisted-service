...
type V2CancelInstallationHandlerFunc func(V2CancelInstallationParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn V2CancelInstallationHandlerFunc) Handle(params V2CancelInstallationParams, principal any) middleware.Responder {
...
type V2CancelInstallationHandler interface {
	Handle(V2CancelInstallationParams, any) middleware.Responder
}
