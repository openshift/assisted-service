...
// UpdateClusterInstallProgressParams contains all the bound params for the update cluster install progress operation
// typically these are obtained from a http.Request
//
// swagger:parameters UpdateClusterInstallProgress
...
//
// To ensure default values, the struct must have been initialized with NewUpdateClusterInstallProgressParams() beforehand.
func (o *UpdateClusterInstallProgressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateClusterInstallProgressParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateClusterInstallProgressParams) validateClusterID(formats strfmt.Registry) error {
