...
func NewListInfraEnvs(ctx *middleware.Context, handler ListInfraEnvsHandler) *ListInfraEnvs {
	return &ListInfraEnvs{Context: ctx, Handler: handler}
}
...
type ListInfraEnvs struct {
	...
	Handler ListInfraEnvsHandler
}

func (o *ListInfraEnvs) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewListInfraEnvsParams()
