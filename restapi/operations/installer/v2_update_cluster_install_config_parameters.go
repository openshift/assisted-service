...
// V2UpdateClusterInstallConfigParams contains all the bound params for the v2 update cluster install config operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2UpdateClusterInstallConfig
...
//
// To ensure default values, the struct must have been initialized with NewV2UpdateClusterInstallConfigParams() beforehand.
func (o *V2UpdateClusterInstallConfigParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2UpdateClusterInstallConfigParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2UpdateClusterInstallConfigParams) validateClusterID(formats strfmt.Registry) error {
