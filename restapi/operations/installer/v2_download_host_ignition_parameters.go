...
// V2DownloadHostIgnitionParams contains all the bound params for the v2 download host ignition operation
// typically these are obtained from a http.Request
//
// swagger:parameters v2DownloadHostIgnition
...
//
// To ensure default values, the struct must have been initialized with NewV2DownloadHostIgnitionParams() beforehand.
func (o *V2DownloadHostIgnitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2DownloadHostIgnitionParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2DownloadHostIgnitionParams) validateHostID(formats strfmt.Registry) error {
...
func (o *V2DownloadHostIgnitionParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *V2DownloadHostIgnitionParams) validateInfraEnvID(formats strfmt.Registry) error {
