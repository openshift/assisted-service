...
func (o *EnableHostParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *EnableHostParams) validateClusterID(formats strfmt.Registry) error {
