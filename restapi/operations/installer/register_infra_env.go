...
type RegisterInfraEnvHandlerFunc func(RegisterInfraEnvParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn RegisterInfraEnvHandlerFunc) Handle(params RegisterInfraEnvParams, principal any) middleware.Responder {
...
type RegisterInfraEnvHandler interface {
	Handle(RegisterInfraEnvParams, any) middleware.Responder
}
