...
func (o *UploadClusterIngressCertURL) Build() (*url.URL, error) {
	...
	if clusterID != "" {
		...
		return nil, errors.New("clusterId is required on UploadClusterIngressCertURL")
	}
...
func (o *UploadClusterIngressCertURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UploadClusterIngressCertURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UploadClusterIngressCertURL")
	}
