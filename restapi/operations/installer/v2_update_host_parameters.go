...
// V2UpdateHostParams contains all the bound params for the v2 update host operation
...
//
// To ensure default values, the struct must have been initialized with NewV2UpdateHostParams() beforehand.
func (o *V2UpdateHostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *V2UpdateHostParams) bindHostID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *V2UpdateHostParams) bindInfraEnvID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
