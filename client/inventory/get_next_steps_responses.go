...
func (o *GetNextStepsOK) Error() string {
	return fmt.Sprintf("[GET /hosts/{host_id}/next-steps][%d] getNextStepsOK  %+v", 200, o.Payload)
}
...
func (o *GetNextStepsNotFound) Error() string {
	return fmt.Sprintf("[GET /hosts/{host_id}/next-steps][%d] getNextStepsNotFound ", 404)
}
...
func (o *GetNextStepsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /hosts/{host_id}/next-steps][%d] getNextStepsInternalServerError ", 500)
}
