...
func (o *PostStepReplyNoContent) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/instructions][%d] postStepReplyNoContent ", 204)
}
...
func (o *PostStepReplyBadRequest) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/instructions][%d] postStepReplyBadRequest ", 400)
}
...
func (o *PostStepReplyNotFound) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/instructions][%d] postStepReplyNotFound ", 404)
}
...
func (o *PostStepReplyInternalServerError) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/instructions][%d] postStepReplyInternalServerError ", 500)
}
