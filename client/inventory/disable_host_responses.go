...
func (o *DisableHostNoContent) Error() string {
	return fmt.Sprintf("[DELETE /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] disableHostNoContent ", 204)
}
...
func (o *DisableHostNotFound) Error() string {
	return fmt.Sprintf("[DELETE /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] disableHostNotFound ", 404)
}
...
func (o *DisableHostConflict) Error() string {
	return fmt.Sprintf("[DELETE /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] disableHostConflict ", 409)
}
...
func (o *DisableHostInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] disableHostInternalServerError ", 500)
}
