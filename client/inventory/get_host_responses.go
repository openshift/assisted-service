...
func (o *GetHostOK) Error() string {
	return fmt.Sprintf("[GET /clusters/{clusterId}/hosts/{hostId}][%d] getHostOK  %+v", 200, o.Payload)
}
...
func (o *GetHostNotFound) Error() string {
	return fmt.Sprintf("[GET /clusters/{clusterId}/hosts/{hostId}][%d] getHostNotFound ", 404)
}
...
func (o *GetHostInternalServerError) Error() string {
	return fmt.Sprintf("[GET /clusters/{clusterId}/hosts/{hostId}][%d] getHostInternalServerError ", 500)
}
