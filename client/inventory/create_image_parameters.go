...
type CreateImageParams struct {
	...
	*/
	NewImageParams *models.ImageCreateParams
...
// WithNewImageParams adds the newImageParams to the create image params
func (o *CreateImageParams) WithNewImageParams(newImageParams *models.ImageCreateParams) *CreateImageParams {
	o.SetNewImageParams(newImageParams)
	return o
}

// SetNewImageParams adds the newImageParams to the create image params
func (o *CreateImageParams) SetNewImageParams(newImageParams *models.ImageCreateParams) {
	o.NewImageParams = newImageParams
}
...
func (o *CreateImageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.NewImageParams != nil {
		if err := r.SetBodyParam(o.NewImageParams); err != nil {
			return err
		}
	}
