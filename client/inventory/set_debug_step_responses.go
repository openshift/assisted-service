...
func (o *SetDebugStepOK) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/debug][%d] setDebugStepOK ", 200)
}
...
func (o *SetDebugStepNotFound) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/debug][%d] setDebugStepNotFound ", 404)
}
...
func (o *SetDebugStepInternalServerError) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/debug][%d] setDebugStepInternalServerError ", 500)
}
