...
func (o *EnableHostNoContent) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] enableHostNoContent ", 204)
}
...
func (o *EnableHostNotFound) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] enableHostNotFound ", 404)
}
...
func (o *EnableHostConflict) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] enableHostConflict ", 409)
}
...
func (o *EnableHostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /clusters/{clusterId}/hosts/{hostId}/actions/enable][%d] enableHostInternalServerError ", 500)
}
