...
func (o *DownloadClusterISOOK) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/actions/download][%d] downloadClusterISOOK  %+v", 200, o.Payload)
}
...
func (o *DownloadClusterISOBadRequest) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/actions/download][%d] downloadClusterISOBadRequest ", 400)
}
...
func (o *DownloadClusterISONotFound) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/actions/download][%d] downloadClusterISONotFound ", 404)
}
...
func (o *DownloadClusterISOInternalServerError) Error() string {
	return fmt.Sprintf("[GET /clusters/{cluster_id}/actions/download][%d] downloadClusterISOInternalServerError ", 500)
}
