...
const (
	...
	// ClusterValidationIDNetworkObservabilityRequirementsSatisfied captures enum value "network-observability-requirements-satisfied"
	ClusterValidationIDNetworkObservabilityRequirementsSatisfied ClusterValidationID = "network-observability-requirements-satisfied"
)
