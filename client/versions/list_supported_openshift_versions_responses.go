...
func (o *ListSupportedOpenshiftVersionsOK) Error() string {
	return fmt.Sprintf("[GET /supported_openshift_versions][%d] listSupportedOpenshiftVersionsOK  %+v", 200, o.Payload)
}
...
func (o *ListSupportedOpenshiftVersionsServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /supported_openshift_versions][%d] listSupportedOpenshiftVersionsServiceUnavailable  %+v", 503, o.Payload)
}
