...
func (o *ListOperatorPropertiesOK) Error() string {
	return fmt.Sprintf("[GET /supported-operators/{operator_type}][%d] listOperatorPropertiesOK  %+v", 200, o.Payload)
}

func (o *ListOperatorPropertiesOK) GetPayload() string {
	return o.Payload
}
...
func (o *ListOperatorPropertiesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /supported-operators/{operator_type}][%d] listOperatorPropertiesUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListOperatorPropertiesForbidden) Error() string {
	return fmt.Sprintf("[GET /supported-operators/{operator_type}][%d] listOperatorPropertiesForbidden  %+v", 403, o.Payload)
}
...
func (o *ListOperatorPropertiesNotFound) Error() string {
	return fmt.Sprintf("[GET /supported-operators/{operator_type}][%d] listOperatorPropertiesNotFound  %+v", 404, o.Payload)
}
...
func (o *ListOperatorPropertiesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /supported-operators/{operator_type}][%d] listOperatorPropertiesInternalServerError  %+v", 500, o.Payload)
}
