...
type ReportMonitoredOperatorStatusParams struct {
	...
	*/
	ReportParams *v1.OperatorMonitorReport
...
func (o *ReportMonitoredOperatorStatusParams) WithReportParams(reportParams *v1.OperatorMonitorReport) *ReportMonitoredOperatorStatusParams {
	o.SetReportParams(reportParams)
	return o
}

// SetReportParams adds the reportParams to the report monitored operator status params
func (o *ReportMonitoredOperatorStatusParams) SetReportParams(reportParams *v1.OperatorMonitorReport) {
