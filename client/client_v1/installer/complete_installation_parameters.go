...
type CompleteInstallationParams struct {
	...
	*/
	CompletionParams *v1.CompletionParams
...
func (o *CompleteInstallationParams) WithCompletionParams(completionParams *v1.CompletionParams) *CompleteInstallationParams {
	o.SetCompletionParams(completionParams)
	return o
}

// SetCompletionParams adds the completionParams to the complete installation params
func (o *CompleteInstallationParams) SetCompletionParams(completionParams *v1.CompletionParams) {
