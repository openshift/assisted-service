...
type RegisterClusterParams struct {
	...
	*/
	NewClusterParams *v1.ClusterCreateParams
...
func (o *RegisterClusterParams) WithNewClusterParams(newClusterParams *v1.ClusterCreateParams) *RegisterClusterParams {
	o.SetNewClusterParams(newClusterParams)
	return o
}

// SetNewClusterParams adds the newClusterParams to the register cluster params
func (o *RegisterClusterParams) SetNewClusterParams(newClusterParams *v1.ClusterCreateParams) {
