...
func (o *RegisterHostParams) WithNewHostParams(newHostParams *v1.HostCreateParams) *RegisterHostParams {
	o.SetNewHostParams(newHostParams)
	return o
}

// SetNewHostParams adds the newHostParams to the register host params
func (o *RegisterHostParams) SetNewHostParams(newHostParams *v1.HostCreateParams) {
