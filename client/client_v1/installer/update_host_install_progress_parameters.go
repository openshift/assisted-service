...
func (o *UpdateHostInstallProgressParams) WithHostProgress(hostProgress *v1.HostProgress) *UpdateHostInstallProgressParams {
	o.SetHostProgress(hostProgress)
	return o
}

// SetHostProgress adds the hostProgress to the update host install progress params
func (o *UpdateHostInstallProgressParams) SetHostProgress(hostProgress *v1.HostProgress) {
